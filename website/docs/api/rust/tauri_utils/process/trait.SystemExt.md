...
Creates a new \[`System`] instance. It only contains the disks' list and the processes list at this stage. Use the [`refresh\_all`](/docs/api/rust/tauri\_utils/about:blank#method.refresh\_all) method to update its internal information (or any of the `refresh\_` method).
...
If you want some more specific refresh, you might be interested into looking at [`refresh\_memory`](/docs/api/rust/tauri\_utils/systemext::refresh\_memory), [`refresh\_cpu`](/docs/api/rust/tauri\_utils/systemext::refresh\_memory) and [`refresh\_temperatures`](/docs/api/rust/tauri\_utils/systemext::refresh\_temperatures).
