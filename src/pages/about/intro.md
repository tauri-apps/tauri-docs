...
If you want to know more about the technical details, then please visit the [Introduction](/next/guides/getting-started/setup). If you want to know more about this project's philosophy - then keep reading.<!-- TODO: revert to stable version on release -->
