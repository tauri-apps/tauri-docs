...
const features = [
  [
    ...
    },
    {
      ...
      description: translate({message: 'Zize of a Tauri App can be less than 600KB'}),
    },
  ],
  [
    {
    ...
    },
    {
      ...
      description: translate({message: 'Here to help you choose important features with simple configuration'}),
    },
    {
      imageUrl: 'img/undraw_cross_platform.svg',
      link: 'docs/development/cross-platform',
      label: translate({message: 'Cross-platform'}),
      description: translate({message: 'Bundle binaries for major desktop platforms (mobile & WASM coming soon)'}),
    },
  ],
]
...
const Roadmap = ({ siteConfig }) => {
  const colors = {
    released: getComputedStyle(document.body).getPropertyValue('--ifm-color-success-lightest'),
    ...
    milestone: getComputedStyle(document.body).getPropertyValue('--ifm-color-danger-lighter'),
  }
