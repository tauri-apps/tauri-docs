...
要了解 Flatpak 的工作原理的详细資訊，您可以阅读[构建您的第一个 Flatpak](https://docs.flatpak.org/en/latest/first-build.html)。
...
如果您的最终二进制文件比默认的 tauri 应用程序需要更多的库，您需要在 flatpak 清单中新增它们。
...
**_5. 将您的应用程序清单新增到分支中。提交更改，然后推送它们。_**
...
您可以在 [flatpak 文档](https://docs.flatpak.org/en/latest/dependencies.html#bundling)中阅读更多相关資訊。
