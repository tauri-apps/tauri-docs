...
SvelteKit 是一个用于 Svelte 的元框架。了解更多关于 SvelteKit 的資訊，请访问 https://kit.svelte.dev/ 。本指南适用于 SvelteKit 2.5.7 / Svelte 4.2.15 版本。
...
4.  ##### 禁用 SSR
    ...
    最后，我们需要通过新增一个名为 `+layout.ts` 文件（如果您不使用 TypeScript，则为 `+layout.js`）并包含以下内容来禁用 SSR 并启用预渲染。
