...
有关 `migrate` 命令的更多資訊，请参阅[命令行接口参考](/zh-tw/reference/cli/#migrate)
...
我们在功能中改变了 Tauri 内置外掛的处理方式 [PR #10390](https://github.com/tauri-apps/tauri/pull/10390)。

要从最新的 Beta 版本迁移，您需要在您的能力中新增所有核心权限标识符 `core:`，或者切换到 `core:default` 权限并删除旧的核心外掛标识符。
...
我们还新增了一个新的特殊权限集 `core:default`，其中包含所有核心外掛的默认权限，这样您就可以简化在能力配置中的权限模板。
