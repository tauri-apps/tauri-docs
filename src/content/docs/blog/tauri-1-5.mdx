...
The Tauri team is excited to announce the 1.5 release. This version includes several new features and important bug fixes such as improved resources bundling, code signing enhancements and `notarytool` migration on macOS.
...
Many people contributed to the 1.5.0 release, we would like to thank everyone that filled issues and pull requests!
Huge thanks to [@tr3ysmith](https://github.com/tr3ysmith) for submitting pull requests to enhance macOS code signing and frameworks and
[@colinhacks](https://github.com/colinhacks) for getting the Tauri CLI to support Bun!
