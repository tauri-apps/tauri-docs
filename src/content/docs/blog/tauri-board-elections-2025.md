...
As we continue to be amazed with all the applications you've created with Tauri v2, it's been 4 years that Tauri has become a Programme within [The Commons Conservancy](https://commonsconservancy.org/)! This means we're preparing for a new round of Tauri Board Director elections for the next term.
...
2. Prepare a written introduction about yourself that covers who you are, your history and relevance for Tauri, and what you would like to bring to the Board. (Examples from previous years can be found on https://github.com/tauri-apps/governance-and-guidance).
