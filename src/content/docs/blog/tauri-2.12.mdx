...
With Rust dropping support for Windows 7 on 1.78.0 in May 2024 (2 years ago) and [`windows-rs`](https://github.com/microsoft/windows-rs) also dropping support in
