...
We have had major contributions to the Tauri repository in 2.0 from [Amr](), [Fabian-Lars](), [Tony](), [Chip](), [icb]() , [Simon](), [Oliver Lemasle]() and many more contributors ([source data](https://github.com/tauri-apps/tauri/graphs/contributors?from=9%2F24%2F2022)).
