...
:::note[TL;DR]
The audit concluded some time ago and all issues were fixed and retested. Report is going to be availe [here](https://github.com/tauri-apps/tauri/blob/dev/audits/Radically_Open_Security-v2-report.pdf) soon. Please upgrade to the release candidate to ensure fixes for the reported issues.
:::
