...
You should be able to automatically migrate from the latest beta to release candidate.

:::tip[Update the CLI]
For this to succeed you must be sure to be on the latest (RC not beta) version of the Tauri [CLI](https://github.com/tauri-apps/tauri/releases?q=tauri-cli&expanded=false).
...
<CommandTabs
  ...
  cargo='cargo add tauri@2.0.0-rc.0
cargo add tauri-build@2.0.0-rc.0 --build
