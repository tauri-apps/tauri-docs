...
Get started building with [`create-tauri-app`](https://github.com/tauri-apps/create-tauri-app) by using one of the below commands. Be sure to follow the [prerequisites guide](/guide/prerequisites/) to install all of the dependencies required by Tauri and then view the [Frontend Configuration guides](/guide/frontend/) for recommended frontend configurations.

import Cta from '../_fragments/cta.mdx';

<Cta />

After you've created your first app you can explore the different features and recipes of Tauri in the [List of Features & Recipes](/features/).
