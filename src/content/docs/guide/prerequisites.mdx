...
![Visual Studio C++ Build Tools installer screenshot](@assets/img/guides/prerequisites/visual-studio-build-tools-installer.png)
...
Next: [Configure for Mobile Targets](#configure-for-mobile-targets) if you'd like to build for Android and iOS, or, if you'd like to use a JavaScript framework, [install Node](#nodejs). Otherwise [Create a Project](/guide/create-project).
...
Next: [Configure for Mobile Targets](#configure-for-mobile-targets) or [Create a project](/guide/create-project).
...
Next: [Setup for iOS](#ios) or [Create a project](/guide/create-project).
...
Next: [Create a project](/guide/create-project).
...
Now that you've installed all of the prerequisistes you're ready to [create your first Tauri project](/guide/create-project)!
