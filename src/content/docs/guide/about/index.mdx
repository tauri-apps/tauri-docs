...
If you're looking for a quick technical overview and to start building an app then visit the [What is Tauri page](/guide/). If you'd like to learn more about the project's philosophy then keep reading.
