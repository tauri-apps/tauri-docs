...
- Add mobile to an existing project (revise what's here [integrate mobile](/guide/create-project))
...
Alternatively, you can [add Tauri to an existing project](/guide/create-project) to quickly turn your existing codebase into a Tauri app.
...
We recommend starting with the vanilla template (HTML, CSS, and JavaScript without a frontend framework) to get started. You can always [integrate a frontend framework](/guide/create-project) later.
...
- [Add and Configure a Frontend Framework](/guide/frontend)
