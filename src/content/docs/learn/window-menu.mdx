  ...
  tauri::Builder::default()
        .setup(|app| {
            ...
            let file_menu = SubmenuBuilder::new(app, "File")
                .text("open", "Open")
                .text("quit", "Quit")
                .icon(menu_image.clone()) // Optional: Add an icon to the submenu
                .build()?;
...
// You can also update the submenu icon dynamically
let icon_image_update = Image::from_bytes(include_bytes!("../icons/icon_update.png")).unwrap();
submenu.set_icon(Some(icon_image_update))?;
// Or set a native icon
