...
2. ##### Create a new page to host your splashscreen
...
3. ##### Open your main window in hidden mode
...
4. ##### Perform some heavy setup task in the backend
...
5. ##### Create a command to determine if setup is complete
...
6. ##### Close the splashscreen window
