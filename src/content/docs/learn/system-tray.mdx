...
or set the `showMenuOnLeftClick` JavaScript option to `false`.

`menu_on_left_click` still works as a deprecated alias in Rust, and `menuOnLeftClick` still works as a deprecated alias in JavaScript, but `show_menu_on_left_click` / `showMenuOnLeftClick` are the current APIs.
:::
...
[`TrayIconBuilder`]: https://docs.rs/tauri/2/tauri/tray/struct.TrayIconBuilder.html
[TrayIconBuilder::show_menu_on_left_click]: https://docs.rs/tauri/2/tauri/tray/struct.TrayIconBuilder.html#method.show_menu_on_left_click
[`TrayIconBuilder::on_menu_event`]: https://docs.rs/tauri/2/tauri/tray/struct.TrayIconBuilder.html#method.on_menu_event
[js TrayIconEvent]: /reference/javascript/api/namespacetray/#trayiconevent
[rust TrayIconEvent]: https://docs.rs/tauri/2/tauri/tray/enum.TrayIconEvent.html
