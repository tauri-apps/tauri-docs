...
<div style={{ display: "flex", alignItems: "center", gap: "1.5rem", width: "100%" }}>
  <div style={{ flex: "none", display: "flex" }}>
    <Image src={RoseRustBook} alt="HTML, CSS, JavaScript, and Rust for Beginners Book Cover" style={{ height: "100%", objectFit: "cover" }} />
  </div>
  <div style={{ display: "flex", flexDirection: "column", flex: "1", gap: "0.20rem" }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "0.15rem" }}>
      ...
      <p style={{ margin: "0" }}>- Free PDF version:{' '}<a href="/assets/learn/community/HTML_CSS_JavaScript_and_Rust_for_Beginners_A_Guide_to_Application_Development_with_Tauri.pdf" style={{ color: "#3b82f6", textDecoration: "none" }}>Download</a>{' '}(PDF 4MB)</p>
    </div>
  </div>
</div>
