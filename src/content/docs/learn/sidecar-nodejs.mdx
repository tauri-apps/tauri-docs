...
Note that we use `"args": true` but you can optionally provide an array `["hello"]`
...
1.  ##### Execute the Sidecar
    ...
    <Tabs syncKey="lang">
      ...
      <TabItem label="Rust">
        ...
        #[tauri::command]
        async fn hello(app: tauri::AppHandle, message: String) -> String {
        ...
        const message = "Tauri"
        console.log(await invoke("hello", { message }))
