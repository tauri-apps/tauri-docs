...
2. Install the JavaScript Guest bindings using your preferred JavaScript package manager:
...
Optionally the window-state plugin can also be accessed through both JavaScript and Rust.
