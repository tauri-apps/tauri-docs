...
| ----------------------------------------- | -------------------------------------------------------------------------- |
| `window-state:allow-restore-state` | Enables the restore_window_state command without any pre-configured scope. |
| `window-state:deny-restore-state`  | Denies the restore_window_state command without any pre-configured scope.  |
