...
With this plugin you can query multiple information from current operational system. See all available functions in the [JavaScript API](/references/2/js/os/) or [Rust API](https://docs.rs/tauri-plugin-os/) references.
