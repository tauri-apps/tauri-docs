...
- [OS Type](#os-type)
- [OS Architeture](#os-architecture)
- [OS Locale](#os-locale)
- [OS Executable extension](#os-executable-extension)
...
// Prints the host name to the console
```
...
// Prints the host name to the terminal
