...
<Tabs>
    ...
    1. **Install :** Add the plugin to the project's dependencies in `Cargo.toml`.
    ...
    2. **Initialize :** Update `lib.rs` (or `main.rs` for desktop-only apps) to initialize the plugin:
