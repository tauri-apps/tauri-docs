...
- [Show a question dialog with `Yes` and `No` buttons](#create-yesno-dialog)
- [Show a question dialog with `Ok` and `Cancel` buttons](#create-okcancel-dialog)
- [Show a message dialog with `Ok` button](#create-message-dialog)
- [Open a file/directory selection dialog](#open-a-file-selector-dialog)
- [Open a file/directory save dialog](#open-a-save-dialog)
