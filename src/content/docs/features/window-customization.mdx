...
- <Icon name="external" class="inline-icon" /> [Through tauri.conf.json](/references/config/#windowconfig)
- <Icon name="external" class="inline-icon" /> [Through the JavaScript API](/references/javascript/api/namespacewindow/#window)
