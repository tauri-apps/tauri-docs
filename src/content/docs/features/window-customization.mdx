...
- [Through the JavaScript API](/references/v2/js/core/namespacewindow/#window)
...
We are going to create the main window and change its background color from the Rust side. Remove the main window from the `tauri.conf.json` file:
