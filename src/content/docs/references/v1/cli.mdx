...
**[See more about the configuration.](./config#build)**
...
For more information, check out the complete [Tauri Icon Guide](../guides/features/icons).
...
See more about the usage through this [complete guide](/guides/develop/development-cycle/).
