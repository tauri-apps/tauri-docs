...
title: 'tauri-bundler@1.0.5'
description: '1.0.5'
slug: 'references/releases/tauri-bundler/v1.0.5'
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/tauri-bundler-v1.0.5">View on GitHub</a></span></div>
