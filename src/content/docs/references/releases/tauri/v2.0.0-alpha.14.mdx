...
title: 'tauri@2.0.0-alpha.14'
description: '2.0.0-alpha.14'
slug: 'references/releases/tauri/v2.0.0-alpha.14'
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/tauri-v2.0.0-alpha.14">View on GitHub</a></span></div>
