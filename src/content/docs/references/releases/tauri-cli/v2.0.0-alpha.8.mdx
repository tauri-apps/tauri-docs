...
title: 'tauri-cli@2.0.0-alpha.8'
description: '2.0.0-alpha.8'
slug: 'references/releases/tauri-cli/v2.0.0-alpha.8'
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/tauri-cli-v2.0.0-alpha.8">View on GitHub</a></span></div>
