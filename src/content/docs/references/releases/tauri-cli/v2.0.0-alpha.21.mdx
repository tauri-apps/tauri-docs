...
title: 'tauri-cli@2.0.0-alpha.21'
description: '2.0.0-alpha.21'
slug: 'references/releases/tauri-cli/v2.0.0-alpha.21'
...
next:
   link: 'references/releases/tauri-cli/v2.0.0-beta.0'
   label: 'v2.0.0-beta.0'
---
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/tauri-cli-v2.0.0-alpha.21">View on GitHub</a></span></div>
