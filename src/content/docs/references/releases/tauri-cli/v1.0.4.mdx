...
title: 'tauri-cli@1.0.4'
description: '1.0.4'
slug: 'references/releases/tauri-cli/v1.0.4'
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/tauri-cli-v1.0.4">View on GitHub</a></span></div>
