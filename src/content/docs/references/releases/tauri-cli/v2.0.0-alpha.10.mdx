...
title: 'tauri-cli@2.0.0-alpha.10'
description: '2.0.0-alpha.10'
slug: 'references/releases/tauri-cli/v2.0.0-alpha.10'
tableOfContents: false
editUrl: 'https://github.com/tauri-apps/tauri-docs/packages/releases-generator/build.ts'
pagefind: false
prev:
   link: 'references/releases/tauri-cli/v2.0.0-alpha.9'
   label: '2.0.0-alpha.9'
next:
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/tauri-cli-v2.0.0-alpha.10">View on GitHub</a></span></div>
