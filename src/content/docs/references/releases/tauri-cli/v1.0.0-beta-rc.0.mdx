...
title: 'tauri-cli@1.0.0-beta-rc.0'
description: '1.0.0-beta-rc.0'
slug: 'references/releases/tauri-cli/v1.0.0-beta-rc.0'
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/tauri-cli-v1.0.0-beta-rc.0">View on GitHub</a></span></div>
