...
title: 'tauri-cli@1.5.9'
description: '1.5.9'
slug: 'references/releases/tauri-cli/v1.5.9'
tableOfContents: false
editUrl: 'https://github.com/tauri-apps/tauri-docs/packages/releases-generator/build.ts'
pagefind: false
prev:
   link: 'references/releases/tauri-cli/v1.5.8'
   label: '1.5.8'
next:
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/tauri-cli-v1.5.9">View on GitHub</a></span></div>
