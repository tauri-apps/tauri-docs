...
title: '@tauri-apps/cli@1.1.1'
description: '1.1.1'
slug: 'references/releases/@tauri-apps/cli/v1.1.1'
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/@tauri-apps/cli-v1.1.1">View on GitHub</a></span></div>
