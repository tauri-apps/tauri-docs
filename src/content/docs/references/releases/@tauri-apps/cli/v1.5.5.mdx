...
title: '@tauri-apps/cli@1.5.5'
description: '1.5.5'
slug: 'references/releases/@tauri-apps/cli/v1.5.5'
tableOfContents: false
editUrl: 'https://github.com/tauri-apps/tauri-docs/packages/releases-generator/build.ts'
pagefind: false
prev:
   link: 'references/releases/@tauri-apps/cli/v1.5.4'
   label: '1.5.4'
next:
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/@tauri-apps/cli-v1.5.5">View on GitHub</a></span></div>
