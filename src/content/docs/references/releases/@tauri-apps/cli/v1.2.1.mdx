...
title: '@tauri-apps/cli@1.2.1'
description: '1.2.1'
slug: 'references/releases/@tauri-apps/cli/v1.2.1'
tableOfContents: false
editUrl: 'https://github.com/tauri-apps/tauri-docs/packages/releases-generator/build.ts'
pagefind: false
prev:
   link: 'references/releases/@tauri-apps/cli/v1.2.0'
   label: '1.2.0'
next:
   link: 'references/releases/@tauri-apps/cli/v1.2.2'
   label: 'v1.2.2'
---
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/@tauri-apps/cli-v1.2.1">View on GitHub</a></span></div>
