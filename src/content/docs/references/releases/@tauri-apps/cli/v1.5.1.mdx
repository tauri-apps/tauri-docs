...
title: '@tauri-apps/cli@1.5.1'
description: '1.5.1'
slug: 'references/releases/@tauri-apps/cli/v1.5.1'
...
prev:
   ...
   label: '1.5.0'
next:
   link: 'references/releases/@tauri-apps/cli/v1.5.2'
   label: 'v1.5.2'
---
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/@tauri-apps/cli-v1.5.1">View on GitHub</a></span></div>
