...
title: '@tauri-apps/cli@2.0.0-beta.6'
description: '2.0.0-beta.6'
slug: 'references/releases/@tauri-apps/cli/v2.0.0-beta.6'
tableOfContents: false
editUrl: 'https://github.com/tauri-apps/tauri-docs/packages/releases-generator/build.ts'
pagefind: false
prev:
   link: 'references/releases/@tauri-apps/cli/v2.0.0-beta.5'
   label: '2.0.0-beta.5'
next:
   link: 'references/releases/@tauri-apps/cli/v2.0.0-beta.7'
   label: 'v2.0.0-beta.7'
---
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/@tauri-apps/cli-v2.0.0-beta.6">View on GitHub</a></span></div>
