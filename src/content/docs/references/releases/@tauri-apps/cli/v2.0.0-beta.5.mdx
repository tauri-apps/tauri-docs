...
title: '@tauri-apps/cli@2.0.0-beta.5'
description: '2.0.0-beta.5'
slug: 'references/releases/@tauri-apps/cli/v2.0.0-beta.5'
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/@tauri-apps/cli-v2.0.0-beta.5">View on GitHub</a></span></div>
