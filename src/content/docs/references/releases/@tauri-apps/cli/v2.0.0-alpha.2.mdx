...
title: '@tauri-apps/cli@2.0.0-alpha.2'
description: '2.0.0-alpha.2'
slug: 'references/releases/@tauri-apps/cli/v2.0.0-alpha.2'
tableOfContents: false
editUrl: 'https://github.com/tauri-apps/tauri-docs/packages/releases-generator/build.ts'
pagefind: false
prev:
   link: 'references/releases/@tauri-apps/cli/v2.0.0-alpha.1'
   label: '2.0.0-alpha.1'
next:
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/tauri/releases/tag/@tauri-apps/cli-v2.0.0-alpha.2">View on GitHub</a></span></div>
