...
title: 'wry@0.6.0'
description: '0.6.0'
slug: 'references/releases/wry/v0.6.0'
...
<div style="margin-bottom:3rem; display: flex; justify-content: space-between; align-items: center"><span>[Return](/releases)</span><span><a href="https://github.com/tauri-apps/wry/releases/tag/wry-v0.6.0">View on GitHub</a></span></div>
