...
Unlike the [WebdriverIO Test Suite](/guides/test/webdriver/example/webdriverio#config), Selenium does not come out of the box with a Test Suite and
...
[WebdriverIO example](/guides/test/webdriver/example/webdriverio#spec), you notice a lot more code that isn't tests, as we have to set up a few
...
[example application setup]: /guides/test/webdriver/example/setup
