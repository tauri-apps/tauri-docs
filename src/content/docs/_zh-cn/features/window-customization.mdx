...
- <Icon name="external" class="inline-icon" /> [通过 JavaScript API](/references/js/core/namespacewindow/#window)
...
:::note
对于 macOS，使用自定义标题栏也会失去系统提供的某些功能，比如[移动或对齐窗口](https：//support.apple.com/guide/mac-help/work-with-app-windows-mchlp2469/mac)。
