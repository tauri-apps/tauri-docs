...
The helper functionss can then be called from the NPM package by using the [`addPluginListener`](/references/js/core/namespacecore/#addpluginlistener) helper function:
