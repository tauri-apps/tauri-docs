...
[event.emit]: http://localhost:4321/reference/javascript/api/namespaceevent#emit
[event.listen]: http://localhost:4321/reference/javascript/api/namespaceevent#listen
[WebviewWindow#emit]: http://localhost:4321/reference/javascript/api/namespacewebviewwindow#emit
[event.emitTo]: http://localhost:4321/reference/javascript/api/namespaceevent#emitto
[WebviewWindow#emitTo]: http://localhost:4321/reference/javascript/api/namespacewebviewwindow#emitto
