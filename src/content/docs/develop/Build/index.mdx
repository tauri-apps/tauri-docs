...
* [Windows](/develop/build/windows/): `-setup.exe`, `.msi`
* [macOS](/develop/build/macos/): `.app`, `.dmg`
* [Linux](/develop/build/macos/): `.deb`, `.appimage` 
* [iOS](/develop/build/macos/): `.ipa` {/* TODO: add new badge to point that this is a 2.0 feature */}
* [Android](/develop/build/macos/): `.apk`
