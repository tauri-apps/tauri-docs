...
:::note
If you are migrating from Tauri v1, the `migrate` command in Tauri v2 CLI should take care of this for you. Read [Automated Migration](/migrate/from-tauri-1/#automated-migration) for more.
:::
