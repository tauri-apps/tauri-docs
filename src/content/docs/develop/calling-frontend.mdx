...
#[tauri::command]
fn download<R: Runtime>(app: AppHandle<R>, url: String) {
...
#[tauri::command]
fn login<R: Runtime>(app: AppHandle<R>, user: String, password: String) {
...
#[tauri::command]
fn open_file<R: Runtime>(app: AppHandle<R>, path: std::path::PathBuf) {
...
#[tauri::command]
fn download<R: Runtime>(app: AppHandle<R>, url: String, on_event: Channel<DownloadEvent>) {
  let content_length = 1000;
  let download_id = 1;
