...
`resources` expects a list of strings targeting files or folders either with absolute or relative paths. It supports glob patterns (bash-style) in case you need to include multiple files from a directory.
