...
Configure your cargo project to take advantage of Rusts size optimization features. [Why is a rust executable large ?](https://lifthrasiir.github.io/rustlog/why-is-a-rust-executable-large.html) provides an excellent explanation of why this matters and an in-depth walkthrough. At the same time, [Minimizing Rust Binary Size](https://github.com/johnthagen/min-sized-rust) is more up-to-date and has a couple of extra recommendations.
