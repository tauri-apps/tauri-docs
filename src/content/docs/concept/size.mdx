...
The [capability system][capabilities] determines which commands are available to your app, and commands that are never allowed can be stripped from the binary entirely.
