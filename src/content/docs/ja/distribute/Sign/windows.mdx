...
もしあなたがここに記載されていない他の署名方式、たとえば「EV 証明書」（「拡張検証 Extended Validation」証明書）などを使用する場合は、証明書発行者の公式文書を確認し、下記の [カスタム署名コマンド](#custom-sign-command) の項を参照してください。
...
<!-- Additional links for JA version -->
