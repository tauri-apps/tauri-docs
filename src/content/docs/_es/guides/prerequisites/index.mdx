...
Siguiente: [Configurar para Móvil](#configurar-para-móvil) si deseas construir para Android e iOS. De lo contrario, [Crea un Proyecto](/guide/create-project).
...
Siguiente: [Configurar para iOS](#ios) o [Crear un proyecto](/guide/create-project).
...
Siguiente: [Crear un proyecto](/guide/create-project).
...
¡Ahora que has instalado todos los prerequisitos estás listo para [crear tu primer proyecto Tauri](/guide/create-project)!
