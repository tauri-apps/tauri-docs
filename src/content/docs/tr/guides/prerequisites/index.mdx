...
2. [Rust](#rust)
3. [Configure for Mobile Targets](#configure-for-mobile-targets) (yalnızca mobil cihazlar için geliştiriliyorsa gereklidir)
...
Sonraki: Android ve iOS için derleme yapmak istiyorsanız [Configure for Mobile Targets](#configure-for-mobile-targets) veya bir JavaScript çerçevesi kullanmak istiyorsanız [Node yükleyin](#nodejs). Aksi takdirde [Create a Project](/guides/create/).
...
Sonraki: [Configure for Mobile Targets](#configure-for-mobile-targets) yada [Bir proje oluşturun](/tr/guides/create/).
...
Kurulum sırasında herhangi bir sorunla karşılaşırsanız [Sorun Giderme Kılavuzu](/tr/guides/troubleshoot)'na göz atmayı veya [Tauri Discord](https://discord.com/invite/tauri)'a ulaşmayı unutmayın.
