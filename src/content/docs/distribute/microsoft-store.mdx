...
Code signing is automatically managed by Microsoft during the submission process,
...
After enrolling as a developer with your Microsoft account, the first step to distribute your Tauri app in the Microsoft Store
is to register your app in the [Apps and Games] page.
...
The installer linked in the Microsoft Installer must be offline.
