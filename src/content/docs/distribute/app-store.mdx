...
See the general [macOS guide][macOS distribution guide] for more information on macOS distribution options and configurations.
...
See the [macOS distribution guide] for more information on configuration options.
...
[macOS distribution guide]: /distribute/macos
