...
See the general [DMG guide][DMG distribution guide] for more information on macOS distribution options and configurations.
...
See the [DMG distribution guide] for more information on configuration options.
...
[DMG distribution guide]: /distribute/dmg
