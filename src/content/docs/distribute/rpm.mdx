...
before veryfiyng the signature you will need to create and import the public key to the rpm database:
...
Finally, you can verify the package with the following command:
