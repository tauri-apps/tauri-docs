...
```
storePassword=<password defined when keytool was executed>
keyPassword=<password defined when keytool was executed>
keyAlias=upload
...
- name: setup Android signing
  run: |
    ...
    echo "storePassword=${{ secrets.ANDROID_STORE_PASSWORD }}" >> keystore.properties
