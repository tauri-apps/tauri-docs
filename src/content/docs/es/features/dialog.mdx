...
<Tabs>
    ...
    1. Usa el gestor de paquetes de tu proyecto para agregar la dependencia:
...
El diálogo está disponible tanto en JavaScript como en Rust. Aquí tienes cómo puedes usarlo:
...
- [Abrir un diálogo de selección de archivos](#open-a-file-selector-dialog)
- [Diálogo de guardar en archivo](#save-to-file-dialog)

en Rust:

- [Construir un diálogo de pregunta](#build-an-ask-dialog)
- [Construir un diálogo de mensaje](#build-a-message-dialog)
- [Construir un diálogo de selección de archivos](#build-a-file-selector-dialog)
...
#### Construye un diálogo de selección de archivos
...
// regresa un `Option` de file_path, o `None` si el usuario cierra el diálogo
```
...
let file_path = app
    ...
    .blocking_save_file();
    // has algo con la ruta de archivo opcional aquí
