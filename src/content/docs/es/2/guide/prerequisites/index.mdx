...
Siguiente: [Configurar para Móvil](#configurar-para-móvil) si deseas construir para Android e iOS. De lo contrario, [Crea un Proyecto](/2/guide/create/).

## Configurar para Objetivos Móvil
...
Agrega los destinos de compilación de iOS con `rustup` en Terminal:
