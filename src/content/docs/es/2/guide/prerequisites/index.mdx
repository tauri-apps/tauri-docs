...
2. [Rust](#rust)
3. [Configurar para Objetivos Móviles](#configurar-para-objetivos-móviles) (solo se requiere si se desarrolla para móviles)

## Dependencias del Sistema

Sigue el enlace para comenzar para tu sistema operativo respectivo:
...
Si tu distribución no está incluida arriba, es posible que desees consultar [Awesome Tauri en GitHub](https://github.com/tauri-apps/awesome-tauri#guides) para ver si se ha creado una guía.

Siguiente: [Instalar Rust](#rust)

### macOS

Tauri usa [Xcode](https://developer.apple.com/xcode/resources/) varias dependencias de desarrollo de macOS e iOS.
...
<details>
<summary>¿Solo desarrollo para objetivos de escritorio?</summary>
...
Siguiente: [Configurar para Objetivos Móviles](#configurar-para-objetivos-móviles) si deseas construir para Android e iOS. De lo contrario, [Crea un Proyecto](/2/guide/create/).

## Configurar para Objetivos Móviles

Si deseas apuntar tu aplicación para Android o iOS, entonces hay algunas dependencias adicionales que necesitas instalar:
...
5. Agrega los objetivos de Android con `rustup`:
...
Siguiente: [Configurar para iOS](#ios) o [Crear un proyecto](/2/guide/create/).

### iOS

:::caution[Solo macOS]
El desarrollo de iOS requiere Xcode y solo está disponible en macOS.
:::

Agrega los objetivos de iOS con `rustup` en Terminal:
...
Siguiente: [Crear un proyecto](/2/guide/create/).

## Solución de Problemas

Si tienes algún problema durante la instalación, asegúrate de revisar la [Guía de Solución de Problemas](/2/guide/troubleshoot) o comunícate en el [Discord de Tauri](https://discord.com/invite/tauri).

<Card title="Siguientes Pasos" icon="rocket">

¡Ahora que has instalado todos los prerequisitos estás listo para [crear tu primer proyecto Tauri](/2/guide/create/)!
