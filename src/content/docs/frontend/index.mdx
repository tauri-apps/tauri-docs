...
<CardGrid>
	<LinkCard title="Next.js" href="/guide/frontend/nextjs" />
	<LinkCard title="Nuxt" href="/guide/frontend/nuxt" />
	<LinkCard title="Qwik" href="/guide/frontend/qwik" />
	<LinkCard title="SvelteKit" href="/guide/frontend/sveltekit" />
	<LinkCard
		title="Vite (recommended)"
		href="/guide/frontend/vite"
	/>
	<LinkCard title="Webpack" href="/guide/frontend/webpack" />
</CardGrid>

## Rust

<CardGrid>
	<LinkCard title="Leptos" href="/guide/frontend/leptos" />
	<LinkCard title="Sycamore" href="/guide/frontend/sycamore" />
	<LinkCard title="Trunk" href="/guide/frontend/trunk" />
	<LinkCard title="Yew" href="/guide/frontend/yew" />
</CardGrid>
...
Don't see a framework listed? It may work with Tauri without any additional configuration required. Read the [configuration checklist](/guide/frontend/#configuration-checklist) for any common configurations to check for.
