...
<CardGrid>
	<LinkCard title="Next.js" href="/frontend/nextjs" />
	<LinkCard title="Nuxt" href="/frontend/nuxt" />
	<LinkCard title="Qwik" href="/frontend/qwik" />
	<LinkCard title="SvelteKit" href="/frontend/sveltekit" />
	<LinkCard
		title="Vite (recommended)"
		href="/frontend/vite"
	/>
	<LinkCard title="Webpack" href="/frontend/webpack" />
</CardGrid>

## Rust

<CardGrid>
	<LinkCard title="Leptos" href="/frontend/leptos" />
	<LinkCard title="Sycamore" href="/frontend/sycamore" />
	<LinkCard title="Trunk" href="/frontend/trunk" />
	<LinkCard title="Yew" href="/frontend/yew" />
</CardGrid>
...
Don't see a framework listed? It may work with Tauri without any additional configuration required. Read the [configuration checklist](/frontend/#configuration-checklist) for any common configurations to check for.
