...
|:-------------------------------------------------- |:--------- |:------------ |:----------------------------------------------------------------------------------------------------------------------------- |
| [`downloadBootstrapper`](#bootstrapper-다운로드) | 예         | 0MB          | `Default` <br /> Results in a smaller installer size, but is not recommended for Windows 7 deployment via `.msi` files. |
| [`embedBootstrapper`](#bootstrapper-포함하기)      | 예         | ~1.8MB       | Better support on Windows 7 for `.msi` installers.                                                                            |
| [`offlineInstaller`](#오프라인-설치-프로그램)           | 아니요       | ~127MB       | Embeds WebView2 installer. Recommended for offline environments.                                                              |
| [`fixedVersion`](#고정된-버전)                   | 아니요       | ~180MB       | Embeds a fixed WebView2 version.                                                                                              |
| [`skip`](#설치-건너뛰기)                   | 아니요       | 0MB          | ⚠️ Not recommended <br /> Does not install the WebView2 as part of the Windows Installer.                               |
