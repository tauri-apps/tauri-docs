...
[windows code signing with github actions]: /ko/guides/build/sign-windows#bonus-sign-your-application-with-github-actions
[macos code signing with github actions]: /ko/guides/build/sign-macos#example
[dependency update guide]: /ko/guides/develop/updating-dependencies
