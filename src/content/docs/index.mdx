...
<a href="/start/" className="card-link card-create">
  <div>
...
<CardGrid>
  <a href="/start/frontend/" className="card-link card-frontend">
...
<a href="/distribute/" className="card-link card-platform">
...
<a href="/security/" className="card-link card-security">
  ...
  <a href="/concept/size/" className="card-link card-size">
