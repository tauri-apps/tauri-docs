...
next: false
hero:
  tagline: Hardened foundation for your web apps
  image:
...
<Card title="New release!" icon="rocket">
<LinkCard title="@tauri-apps/api 2.0.0" description='2024-01-03' />
<LinkCard title="@tauri-apps/cli 1.5.3" description='2024-05-24' />
<LinkCard title="tauri 2.3.0" description='2025-02-12' />
</Card>
</div>
