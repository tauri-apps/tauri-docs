...
TODO: How should we handle all the billion linux distros so we don't have to necessarily maintain them all?
...
2. During installation check the "Desktop development with C++" option. This should automatically select the first two items in the optional details that Tauri requires (MSVC build tools and the Windows SDK).
