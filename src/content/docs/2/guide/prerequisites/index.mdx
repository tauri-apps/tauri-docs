...
If you run into any issues during installation be sure to check the [Troubleshooting Guide](/2/guide/troubleshoot) or reach out on the [Tauri Discord](https://discord.com/invite/tauri).
