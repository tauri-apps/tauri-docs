...
{/* TODO: Should there be a CLI option to not include kotlin and swift? */}
...
Builder::new("<plugin-name>")
  .setup(|app, api| {
    ...
    // TODO: some nice example code here?
...
- **When**: New window is being created
- **Why**: TODO:
...
Builder::new("<plugin-name>")
  .on_webview_ready(|window| {
    // TODO: Maybe a more practical example?
