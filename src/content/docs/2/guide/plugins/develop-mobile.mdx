...
Be sure that you're familiar with the [Plugin Development guide](/2/guide/plugins) as a lot of concepts in this guide build on top of foundations covered there.
...
Tauri automatically implements two commands for your plugin: `checkPermissions` and `requestPermissions`. You can call that command directly from JavaScript or Rust:
