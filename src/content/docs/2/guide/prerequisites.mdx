...
:::caution[macOS Only]
iOS development is only available on macOS as it requires Xcode.
:::

Add the iOS targets with `rustup`:
...
Now that you've installed all of the prerequisistes you're ready to [create your first Tauri project](/2/guide/create-project/)!
