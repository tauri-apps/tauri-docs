...
- [Linux](#linux) (see the section below for specific distributions)
...
Now that you've installed all of the prerequisistes you're ready to [create your first Tauri project](/getting-started/create-project/)!
