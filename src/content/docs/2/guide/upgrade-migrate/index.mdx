...
This guide walks you through migrating your Tauri 1.0 application to Tauri 2.0. The Tauri v2 CLI includes a `migrate` command that automates most of the process and helps you finish the migration:
