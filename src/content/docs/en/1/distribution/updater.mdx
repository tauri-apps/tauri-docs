...
<Tabs tabTitles={["Bash", "PowerShell"]}>
  <div slot="Bash">
...
![Default updater dialog](./assets/updater/update-available.png)
...
<Callout kind="caution">
  You need to disable the built-in dialog in your [Tauri
  configuration](#tauri-configuration) to enable the JavaScript APIs and updater
  events!
</Callout>
