...
Suivant: [Configuration pour Mobile](#configuration-pour-mobile) si vous voulez construire une application pour Android et iOS. Dans le cas contraire, [Create a Project](/guide/create-project).
...
Suivant: [Installation pour Android](#ios) ou [Create a project](/guide/create-project).
...
Suivant: [Create a project](/guide/create-project).
...
Maintenant que vous avez installé tous les prérequis, vous êtes fin prêt pour [créer votre premier projet Tauri](/guide/create-project) !
