...
下一步：[配置移动端](#移动端配置) 如果你想要在 Android 或 iOS 上开发应用。否则前往 [创建新项目](/guides/create/)。
...
如果您在安装过程中遇到任何问题，请务必查看 [故障诊断指南](/guides/troubleshoot/) 或联系 [Tauri Discord](https://discord.com/invite/tauri) 以寻求帮助。

<Card title="下一步" icon="rocket">

现在，您已经安装了所有前置要求，您可以准备好 [创建您的第一个 Tauri 应用程序](/guides/create/)！
