...
e lo script che lo fa partire, puoi farlo grazie ai campi [devUrl](../reference/config.md#devurl) e
[beforeDevCommand](../reference/config.md#beforedevcommand) nel file di configurazione:
