...
The process plugin is available in both JavaScript and Rust. Note: the JavaScript `relaunch()` doesn't work on MacOS apps, please use the Rust `restart()` command instead.
