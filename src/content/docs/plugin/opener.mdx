...
Here is an example on how add permission to a specific path for the openPath() function:
...
Here is an example on how add permission for a custom protocol for the openUrl() function:
