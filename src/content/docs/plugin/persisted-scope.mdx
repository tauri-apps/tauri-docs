...
If the plug-in does not seem to save the scope, make sure that this plug-in is initialized AFTER the fs plug-in. If it is not the case, you should see a warning message upon launching your app in dev mode, similar to this:
