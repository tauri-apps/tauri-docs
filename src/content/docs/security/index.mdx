---
title: Security
description: High-level concepts and security features at the core of Tauri's design and ecosystem that make you, your applications and your users more secure by default
sidebar:
  order: 1
  label: Overview
i18nReady: true
