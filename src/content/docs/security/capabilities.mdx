...
{/* TODO maybe a link to an example would be better here. */}
By default, all commands that you defined in your app
(using the
[`#[tauri::command]`](https://docs.rs/tauri/2.0.0/tauri/attr.command.html)
macro)
