...
![Threat Stages During Development](@assets/concepts/application-flow-simple.svg)
...
And please, whatever you do, **DO NOT** trust the results of cryptography using
private keys in the Webview.
