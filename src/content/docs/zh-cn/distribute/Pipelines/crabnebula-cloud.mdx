...
[CrabNebula 云](https://crabnebula.dev/cloud/)是一个与 Tauri 更新程序无缝集成的应用分发平台。

该云提供了一个内容传递网络（CDN），能够以成本效益的方式全球运送您的应用程序安装程序和更新，并公开下载指标。

通过 CrabNebula 云服务，实现多个发布渠道、应用网站的下载按钮等非常简单。
