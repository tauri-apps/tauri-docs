...
:::note
这个指南中的一些部分是可选的。这包括配置脚本和其他特定步骤。根据您的具体需求和要求，可以自由地调整说明。
:::

本指南介绍了如何分发和管理RPM软件包，包括获取软件包信息、配置脚本、设置依赖关系和签名软件包。
...
有关epoch的更多信息，请查看：[RPM 打包指南](https://rpm-packaging-guide.github.io/#epoch-scriptlets-and-triggers).
:::
