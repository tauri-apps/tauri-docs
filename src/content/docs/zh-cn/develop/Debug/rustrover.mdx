...
在本指南中，我们将通过设置 JetBrains RustRover 来调试 [Core Process of your Tauri app](/concept/process-model/#the-core-process)。这也基本适用于 IntelliJ 和 CLion 。
...
现在，我们可以选择性地将运行/调试的配置重命名为某个更容易记住的名称，在这个例子中，我们将其命名为 "Run Tauri App" ，但你也可以任意命名。
