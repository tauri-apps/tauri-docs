...
Ce guide explique comment configurer VS Code pour déboguer le [processus Core de votre app Tauri](/fr/concept/process-model/#the-core-process).
...
Le débogueur de Visual Studio pour Windows est un débogueur uniquement disponible pour Windows. Il est généralement plus rapide que [`vscode-lldb`] et offre une meilleure prise en charge de certaines fonctionnalités de Rust comme les énumérations.

### Prérequis

Installez l'extension [C/C++](https://marketplace.visualstudio.com/items?itemName=ms-vscode.cpptools) et suivez le guide https://code.visualstudio.com/docs/cpp/config-msvc#_prerequisites pour installer le débogueur Visual Studio pour Windows.
