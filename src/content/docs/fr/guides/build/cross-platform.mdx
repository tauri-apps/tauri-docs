...
[windows code signing with github actions]: /guides/build/sign-windows#bonus-sign-your-application-with-github-actions
[macos code signing with github actions]: /guides/build/sign-macos#example
[dependency update guide]: /guides/develop/updating-dependencies
