---
title: Compilation multiplatforme ou compilation croisée
---
...
<CommandTabs
	npm="npm run build --target x86_64-pc-windows-msvc"
	yarn="yarn build --target x86_64-pc-windows-msvc"
	pnpm="pnpm build --target x86_64-pc-windows-msvc"
	cargo="cargo build --target x86_64-pc-windows-msvc"
/>

The build output will then be in `target/x86_64-pc-windows-msvc/release/bundle/nsis/`.


[windows code signing with github actions]: /fr/guides/build/sign-windows#bonus-sign-your-application-with-github-actions
[macos code signing with github actions]: /fr/guides/build/sign-macos#example
[dependency update guide]: /fr/guides/develop/updating-dependencies
