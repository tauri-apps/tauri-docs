...
[`tauri.bundle.macos.minimumsystemversion`]: /fr/references/v2/config#macconfig.minimumsystemversion
[`package.productname`]: /fr/references/v2/config#packageconfig.productname
[`package.version`]: /fr/references/v2/config#packageconfig.version
[`tauri.bundle.category`]: /fr/references/v2/config#bundleconfig.category
[`tauri.bundle.copyright`]: /fr/references/v2/config#bundleconfig.copyright
[`tauri.bundle.icon`]: /fr/references/v2/config#bundleconfig.icon
[`tauri.bundle.macos.license`]: /fr/references/v2/config#bundleconfig.icon
[`tauri.bundle.macos.entitlements`]: /fr/references/v2/config#macconfig.entitlements
[`tauri.bundle.macos.exceptiondomain`]: /fr/references/v2/config#macconfig.exceptiondomain
