...
[`tauri.bundle.macos.minimumsystemversion`]: /fr/2/reference/config#macconfig.minimumsystemversion
[`package.productname`]: /fr/2/reference/config#packageconfig.productname
[`package.version`]: /fr/2/reference/config#packageconfig.version
[`tauri.bundle.category`]: /fr/2/reference/config#bundleconfig.category
[`tauri.bundle.copyright`]: /fr/2/reference/config#bundleconfig.copyright
[`tauri.bundle.icon`]: /fr/2/reference/config#bundleconfig.icon
[`tauri.bundle.macos.license`]: /fr/2/reference/config#bundleconfig.icon
[`tauri.bundle.macos.entitlements`]: /fr/2/reference/config#macconfig.entitlements
[`tauri.bundle.macos.exceptiondomain`]: /fr/2/reference/config#macconfig.exceptiondomain
