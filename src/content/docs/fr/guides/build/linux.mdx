...
<summary>Click to see the full example file for Ubuntu 22.04</summary>
...
[ressource]: /fr/guides/build/resources/
[sidecar]: /fr/guides/build/sidecar/
[system requirements]: /fr/guides/prerequisites#linux
[Tauri using Cargo]: /fr/guides/guides/create#using-create-tauri-app
