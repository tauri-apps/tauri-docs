...
Apprenez-en plus à-propos de la commande `migrate` dans l'[interface de référence des commandes](/references/2/cli#migrate)
...
[Référence de l'API de configuration de Tauri 2.0](/references/2/config)
