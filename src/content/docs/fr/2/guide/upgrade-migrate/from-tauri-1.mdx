...
Apprenez-en plus à-propos de la commande `migrate` dans l'[interface de référence des commandes](/fr/2/reference/cli#migrate) 

Learn more about the `migrate` command in the [Command Line Interface reference](/fr/2/reference/cli#migrate)
...
[Référence de l'API de configuration de Tauri 2.0](/fr/2/reference/config)
