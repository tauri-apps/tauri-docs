...
Suivant: [Configuration pour Mobile](#configuration-pour-mobile) si vous voulez construire une application pour Android et iOS. Dans le cas contraire, [Create a Project](/fr/2/guide/create/).
...
Suivant: [Installation pour Android](#ios) ou [Create a project](/fr/2/guide/create/).
...
Suivant: [Create a project](/fr/2/guide/create/).


## Problèmes

Si vous rencontrez un problème durant l'installation, assurez-vous de consulter le [guide de résolution de problèmes](/fr/2/guide/troubleshoot) ou rejoignez le [Discord de Tauri](https://discord.com/invite/tauri)


<Card title="Next Steps" icon="rocket">

Maintenant que vous avez installé tous les prérequis, vous êtes fin prêt pour [créer votre premier projet Tauri](/fr/2/guide/create/) !
