...
{/* Note: Ce sont les distributions supportées officielles. */}
{/* Si vous voulez en ajouter une autre, ouvrez une issue sur github pour discuter avant d'ouvrir un PR */}
...
Tauri utilise les Outils de Développement C++ de Microsoft (Microsoft C++ Build Tools) ainsi que Microsoft Edge WebView2. Ils sont tous les deux requis pour le développement Windows.
...
## Rust
Tauri est construit avec [Rust](https://www.rust-lang.org) et l'exige pour fonctionner. Installez Rust en utilisant une des méthodes suivantes. Vous pouvez voir plus de méthodes d'installation sur https://www.rust-lang.org/tools/install.
...
Suivant: [Configuration pour Mobile](#configuration-pour-mobile) si vous voulez construire une application pour Android et iOS. Dans le cas contraire, [Create a Project](/2/guide/create/).
...
3. Utilisez le SDK Manager dans Android Studio pour installer ce qui suit:
...
Suivant: [Installation pour Android](#ios) ou [Create a project](/2/guide/create/).
...
Suivant: [Create a project](/2/guide/create/).

## Problèmes

Si vous rencontrez un problème durant l'installation, assurez-vous de consulter le [guide de résolution de problèmes](/2/guide/troubleshoot) ou rejoignez le [Discord de Tauri](https://discord.com/invite/tauri)

<Card title="Next Steps" icon="rocket">

Maintenant que vous avez installé tous les prérequis, vous êtes fin prêt pour [créer votre premier projet Tauri](/2/guide/create/) !
