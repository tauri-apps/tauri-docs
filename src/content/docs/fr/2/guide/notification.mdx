...
<Tabs>
    ...
    3. Si vous voulez utiliser les notification de Javascript, vous devez aussi installer le package npm: If you'd like to use notifications in JavaScript then install the npm package as well:
...
- [Ajouter une pièce jointe à une notification](#pièce-jointe)
