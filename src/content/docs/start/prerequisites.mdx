...
```
:::tip
It is recommended to restart your PC so powershell can pick up the new environment variables
but you can refresh the current powershell session by using this command
```ps
