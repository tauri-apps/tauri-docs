...
- `tauri.conf.json` is the main configuration file for Tauri, it contains everything from the application identifier to dev server url,
  ...
  to learn more about it, see [Configuration](/reference/config/)
- `capabilities/` directory is the default folder Tauri reads [capability files](/security/capabilities/) from, to learn more about it, see [Security](/security/)
