...
Learn more about the `migrate` command in the [Command Line Interface reference](/references/cli#migrate)
...
[Tauri 2.0 Configuration API reference](/references/config)
...
To learn more about permissions and capabilities, see [the documentation](/references/acl).
