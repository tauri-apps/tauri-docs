...
<Steps>
    ...
    2. Then, install Tauri's CLI tool using your package manager of choice.
        ...
        :::note
        If you are using `cargo` to install the Tauri CLI, you can't install it locally in your project.
        :::
    ...
    4. In your project directory, initialize Tauri:
        ...
        :::note
        It's important to make sure that the dev server port is correct. Tauri will run the configured dev command when you run `tauri dev` and the build command when you run `tauri build`.
        :::
