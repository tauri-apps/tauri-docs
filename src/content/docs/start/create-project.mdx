...
- Add mobile to an existing project (revise what's here [integrate mobile](/start/create-project))
...
After `create-tauri-app` has complete you can navigate into your project's folder, install dependencies, then use the [Tauri CLI](/references/cli) to start the development server:
...
- [Add and Configure a Frontend Framework](/start/frontend-configuration)
- [Tauri Command Line Interface (CLI) Reference](/references/cli)
