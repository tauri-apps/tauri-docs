...
Therefore we analysed several [threats](#threat-model) you should be aware when developing
a Tauri application and provide you with additional [best practices](#best-practices) to reduce risk or
