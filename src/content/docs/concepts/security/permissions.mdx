...
With **crate-name** we refer to the plugin crate name.
...
The plugin prefix `tauri-plugin-` will be automatically appended to the identifier of plugins
...
Simplified example of an example Tauri __plugin__ directory structure:
...
For __application__ developers the structure is different and described
in the capabilities [configuration section](/concepts/security/capabilities#configuration-files).
