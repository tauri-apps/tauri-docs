...
You can contribute to Tauri documentation in a number of ways:
...
1. Clone [tauri-docs](https://github.com/tauri-apps/tauri-docs) repo
...
You can use Gitpod or GitHub Codespaces to edit the documentation in your browser:
...
[Allow Gitpod to open new tabs](https://www.gitpod.io/docs/configure/user-settings/browser-settings) so that you get a new tab popping up with the documentation when the environment is done loading.
