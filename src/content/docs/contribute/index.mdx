...
Each of those Tauri repositories contains a CONTRIBUTING.md file in the root of the project. In it you will find instructions on how to set up local development environment and submit a Pull Request. 
