...
Once you completed the steps above and your app builds and runs without any errors, you can follow this [guide](https://docs.flathub.org/docs/for-app-authors/submission/) to publish your app on the Flathub store.
