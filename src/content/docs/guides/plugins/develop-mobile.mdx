...
The helper functionss can then be called from the NPM package by using the [`addPluginListener`](/references/2/js/core/namespaceprimitives/#addpluginlistener) helper function:
