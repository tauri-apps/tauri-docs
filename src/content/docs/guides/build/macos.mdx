...
[`tauri.bundle.macos.minimumsystemversion`]: /2/reference/config#macconfig.minimumsystemversion
[`package.productname`]: /2/reference/config#packageconfig.productname
[`package.version`]: /2/reference/config#packageconfig.version
[`tauri.bundle.category`]: /2/reference/config#bundleconfig.category
[`tauri.bundle.copyright`]: /2/reference/config#bundleconfig.copyright
[`tauri.bundle.icon`]: /2/reference/config#bundleconfig.icon
[`tauri.bundle.macos.license`]: /2/reference/config#bundleconfig.icon
[`tauri.bundle.macos.entitlements`]: /2/reference/config#macconfig.entitlements
[`tauri.bundle.macos.exceptiondomain`]: /2/reference/config#macconfig.exceptiondomain
