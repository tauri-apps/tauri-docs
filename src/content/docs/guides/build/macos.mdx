...
[`tauri.bundle.macos.minimumsystemversion`]: /references/v2/config#macconfig.minimumsystemversion
[`package.productname`]: /references/v2/config#packageconfig.productname
[`package.version`]: /references/v2/config#packageconfig.version
[`tauri.bundle.category`]: /references/v2/config#bundleconfig.category
[`tauri.bundle.copyright`]: /references/v2/config#bundleconfig.copyright
[`tauri.bundle.icon`]: /references/v2/config#bundleconfig.icon
[`tauri.bundle.macos.license`]: /references/v2/config#bundleconfig.icon
[`tauri.bundle.macos.entitlements`]: /references/v2/config#macconfig.entitlements
[`tauri.bundle.macos.exceptiondomain`]: /references/v2/config#macconfig.exceptiondomain
