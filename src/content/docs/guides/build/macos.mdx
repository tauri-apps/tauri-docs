...
[`tauri.bundle.macos.minimumsystemversion`]: /2/reference/config.md#macconfig.minimumsystemversion
[`package.productname`]: /2/reference/config.md#packageconfig.productname
[`package.version`]: /2/reference/config.md#packageconfig.version
[`tauri.bundle.category`]: /2/reference/config.md#bundleconfig.category
[`tauri.bundle.copyright`]: /2/reference/config.md#bundleconfig.copyright
[`tauri.bundle.icon`]: /2/reference/config.md#bundleconfig.icon
[`tauri.bundle.macos.license`]: /2/reference/config.md#bundleconfig.icon
[`tauri.bundle.macos.entitlements`]: /2/reference/config.md#macconfig.entitlements
[`tauri.bundle.macos.exceptiondomain`]: /2/reference/config.md#macconfig.exceptiondomain
