...
[`tauri.bundle.windows.wix.template`]: /references/v2/config#wixconfig.template
[`tauri.bundle.windows.nsis.template`]: /references/v2/config#nsisconfig.template
...
[`tauri.bundle.windows.wix.language`]: /references/v2/config#wixconfig.language
