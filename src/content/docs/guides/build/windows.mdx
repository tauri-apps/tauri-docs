...
[webviewinstallmode]: /2/reference/config#webviewinstallmode
[`tauri.bundle.windows.wix.template`]: /2/reference/config#wixconfig.template
[`tauri.bundle.windows.nsis.template`]: /2/reference/config#nsisconfig.template
...
[`tauri.bundle.windows.wix.language`]: /2/reference/config#wixconfig.language
