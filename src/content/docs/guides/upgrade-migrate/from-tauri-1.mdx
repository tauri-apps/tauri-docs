...
Learn more about the `migrate` command in the [Command Line Interface reference](/references/2/cli#migrate)
...
[Tauri 2.0 Configuration API reference](/references/2/config)
