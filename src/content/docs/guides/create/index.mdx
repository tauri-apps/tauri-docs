...
<Steps>
    ...
    2. Create a new directory for your project and initialize a your app. You can use any frontend framework you prefer, like NextJS, Nuxt, Svelte, or just plaing HTML, CSS, and JavaScript.
    ...
    3. In your project directory, initialize Tauri:
        ...
        ? Where are your web assets (HTML/CSS/JS) located, relative to the "<current dir>/src-tauri/tauri.con ✔ Where are your web assets (HTML/CSS/JS) located, relative to the "<current dir>/src-tauri/tauri.conf.json" file that will be created? ../build
