...
1. Download and install [Node LTS](https://nodejs.org)
...
While npm is the default package manager, you can easily enable pnpm and yarn by running `corepack enable` on your Terminal.
