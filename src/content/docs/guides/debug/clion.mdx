...
![Add Run/Debug Configuration](../../../../assets/img/guides/debugging/clion/add-cargo-config-light.png)
{/* ![Add Run/Debug Configuration](../../../../assets/img/debugging/clion/add-cargo-config-dark.png#gh-dark-mode-only) */}
...
![Add `--no-default-features` flag](../../../../assets/img/guides/debugging/clion/set-no-default-features-light.png)
{/* ![Add `--no-default-features` flag](../../../../assets/img/guides/debugging/clion/set-no-default-features-dark.png#gh-dark-mode-only) */}
...
![Rename Configuration](../../../../assets/img/guides/debugging/clion/rename-configuration-light.png)
{/* ![Rename Configuration](../../../../assets/img/guides/debugging/clion/rename-configuration-dark.png#gh-dark-mode-only) */}
