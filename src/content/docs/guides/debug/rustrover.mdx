...
![Add Run/Debug Configuration](../../../../assets/img/guides/debugging/rustrover/add-cargo-config-light.png)
{/* ![Add Run/Debug Configuration](../../../../assets/img/guides/debugging/rustrover/add-cargo-config-dark.png#gh-dark-mode-only) */}
...
![Add `--no-default-features` flag](../../../../assets/img/guides/debugging/rustrover/set-no-default-features-light.png)
{/* ![Add `--no-default-features` flag](../../../../assets/img/guides/debugging/rustrover/set-no-default-features-dark.png#gh-dark-mode-only) */}
...
![Rename Configuration](../../../../assets/img/guides/debugging/rustrover/rename-configuration-light.png)
{/* ![Rename Configuration](../../../../assets/img/guides/debugging/rustrover/rename-configuration-dark.png#gh-dark-mode-only) */}
...
![NPM Configuration](../../../../assets/img/guides/debugging/rustrover/npm-configuration-light.png)
{/* ![NPM Configuration](../../../../assets/img/guides/debugging/rustrover/npm-configuration-dark.png#gh-dark-mode-only) */}
...
![Trunk Serve Configuration](../../../../assets/img/guides/debugging/rustrover/trunk-configuration-light.png)
{/* ![Trunk Serve Configuration](../../../../assets/img/guides/debugging/rustrover/trunk-configuration-dark.png#gh-dark-mode-only) */}
...
![Debug Session](../../../../assets/img/guides/debugging/rustrover/debug-session-light.png)
{/* ![Debug Session](../../../../assets/img/guides/debugging/rustrover/debug-session-dark.png#gh-dark-mode-only) */}
...
[core process of your tauri app]: ../../concepts/process-model#the-core-process
