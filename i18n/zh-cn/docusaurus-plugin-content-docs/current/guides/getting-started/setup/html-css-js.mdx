...
<TauriInit
  destDirExplination={{ __html: '使用 <code>../ui</code> 作为这一项的值。' }}
  devPathExplination={{ __html: '使用 <code>../ui</code> 作为这一项的值。' }}
  beforeDevCommandExplination={{
    __html: '可以留空，因为没有东西需要被编译。',
  }}
...
<html lang="en">
  ...
  <body>
    ...
    <script>
      ...
      // 现在我们可以调用我们的命令！
      // 您会看到 “Welcome from Tauri” 被 “Hello, World!” 替换。
