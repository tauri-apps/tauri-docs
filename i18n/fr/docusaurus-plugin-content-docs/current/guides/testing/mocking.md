...
[`mockWindows()`][] only fakes the existence of windows but no window properties. Pour simuler les propriétés de la fenêtre, vous devez intercepter les appels corrects en utilisant [`mockIPC()`][]
