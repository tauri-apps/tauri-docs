...
export default defineConfig({
	...
	redirects: {
		...
		'/v1/guides/building/windows': '/guides/building/windows',
		'/v1/guides/building/macos': '/guides/building/macos',
		'/v1/guides/building/linux': '/guides/building/linux',
		'/v1/guides/building/cross-platform': '/guides/building/cross-platform',
		...
		'/fr/v1/guides/building/linux': '/fr/guides/building/linux',
		'/fr/v1/guides/building/cross-platform': '/fr/guides/building/cross-platform',
		...
		'/zh-cn/v1/guides/building/linux': '/zh-cn/guides/building/linux',
		'/zh-cn/v1/guides/building/cross-platform': '/zh-cn/guides/building/cross-platform',
