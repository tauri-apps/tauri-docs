...
the [changelog table](/release/table/). The [core releases](/release/core/) page
groups `tauri`, `@tauri-apps/api`, and CLI changes by minor version, showing
packages released together as one entry. For per-platform plugin availability,
