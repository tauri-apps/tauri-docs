...
import desktopLightPreview from '/img/guides/getting-started/setup/next-js/next-js-light.png'
import desktopDarkPreview from '/img/guides/getting-started/setup/next-js/next-js-dark.png'
import androidLightPreview from '/img/guides/getting-started/setup/next-js/android-next-js-light.png'
import iosLightPreview from '/img/guides/getting-started/setup/next-js/ios-next-js-light.png'
import desktopLightApplicationWindow from '/img/guides/getting-started/setup/next-js/next-js-dev-light.png'
import desktopDarkApplicationWindow from '/img/guides/getting-started/setup/next-js/next-js-dev-dark.png'
...
For mobile support you also need the `internal-ip` NPM dependency to resolve your public address.
...
`export: 'static'` will change the behavior of the `next build` to produce an `out/` folder containing the HTML/CSS/JS assets for your application instead of writing them to a `.next/` directory specific to Next.js' runtime.
...
<TauriInit
  ...
  beforeDevCommandExplination={{
    __html:
      'Use <code>npm run dev</code> for this value. For mobile support use <code>npm run dev -- -H $HOST</code>. (make sure to adapt this to use the package manager of your choice)',
  }}
/>
