...
import desktopLightPreview from './assets/next-js/next-js-light.png'
import desktopDarkPreview from './assets/next-js/next-js-dark.png'
import androidLightPreview from './assets/next-js/android-next-js-light.png'
import iosLightPreview from './assets/next-js/ios-next-js-light.png'
import desktopLightApplicationWindow from './assets/next-js/next-js-dev-light.png'
import desktopDarkApplicationWindow from './assets/next-js/next-js-dev-dark.png'
...
<TauriInit
  ...
  beforeDevCommandExplination={{
    __html: 'Use <code>npm run dev</code> for this value. For mobile support use <code>npm run dev -- -h $HOST</code>.',
  }}
/>
