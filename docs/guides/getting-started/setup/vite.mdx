...
<Image img={'/img/guides/vite-light.png#gh-light-mode-only'} />
<Image img={'/img/guides/vite-dark.png#gh-dark-mode-only'} />
...
<Image img={'/img/guides/vite-dev-light.png#gh-light-mode-only'} />
<Image img={'/img/guides/vite-dev-dark.png#gh-dark-mode-only'} />
