...
<TauriInit
  destDirExplination={{
    __html: 'Use <code>vite-project/dist</code> for this value.',
  }}
  devPathExplination={{
  ...
  beforeDevCommandExplination={{
    __html:
      'Use <code>cd vite-project && npm run dev</code> (be sure to adapt to use your package manager of choice).',
  }}
  beforeBuildCommandExplination={{
    __html:
      'Use <code>cd vite-project && npm run build</code> (be sure to adapt to use your package manager of choice).',
  }}
/>
...
```json title=src-tauri/tauri.conf.json
{
  "build": {
    ...
    "beforeBuildCommand": "cd vite-project && npm run build",
    // This command will execute when you run `tauri dev`
    "beforeDevCommand": "cd vite-project && npm run dev",
