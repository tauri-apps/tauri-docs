...
<Image className="gh-light-mode-only" img={require('./vite-light.png')} />
<Image className="gh-dark-mode-only" img={require('./vite-dark.png')} />
...
<Image className="gh-light-mode-only" img={require('./vite-dev-light.png')} />
<Image className="gh-dark-mode-only" img={require('./vite-dev-dark.png')} />
