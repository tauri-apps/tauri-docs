...
import desktopLightPreview from '/img/guides/getting-started/setup/vite/vite-light.png'
import desktopDarkPreview from '/img/guides/getting-started/setup/vite/vite-dark.png'
import androidLightPreview from '/img/guides/getting-started/setup/vite/android-vite-light.png'
import iosLightPreview from '/img/guides/getting-started/setup/vite/ios-vite-light.png'
import desktopLightApplicationWindow from '/img/guides/getting-started/setup/vite/vite-dev-light.png'
import desktopDarkApplicationWindow from '/img/guides/getting-started/setup/vite/vite-dev-dark.png'
