...
![html-css-js-light](/img/guides/vite-light.png#gh-light-mode-only)
![html-css-js-dark](/img/guides/vite-dark.png#gh-dark-mode-only)
...
![html-css-js-light](/img/guides/vite-dev-light.png#gh-light-mode-only)
![html-css-js-dark](/img/guides/vite-dev-dark.png#gh-dark-mode-only)

## Invoke Commands

<Commands />

To call our newly created command we will use the [`@tauri-apps/api`] JavaScript library. It provides access to core functionaly such as windows, the filesystem, and more through convenient JavaScript abstractions. You can install it using your favourite JavaScript package manager:
...
With the library installed, you can modify your `index.html` file to call the Command:
