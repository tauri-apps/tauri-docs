...
Note that if you are not using vanilla JavaScript, you should modify this config and add the necessary plugins your framework requires.
...
Be sure that tauri is accessible to your package manager of choice. For example if you are using npm, the `package.json` file should include tauri as a script:
