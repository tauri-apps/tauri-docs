...
You'll use `../dist` for step 3 (this is Vite's default output directory) and `http://localhost:5173` (or whichever port you've set in your Vite config) for step 4.
