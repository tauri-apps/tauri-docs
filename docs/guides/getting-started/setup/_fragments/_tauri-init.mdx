...
<ol>
  ...
  <li>
    ...
    {props.destDirExplination && (
      <span dangerouslySetInnerHTML={props.destDirExplination} />
    )}
  </li>
  <br />
  <li>
    ...
    {props.devPathExplination && (
      <span dangerouslySetInnerHTML={props.devPathExplination} />
    )}
  </li>
  <br />
  <li>
    ...
    {props.beforeDevCommandExplination && (
      <span dangerouslySetInnerHTML={props.beforeDevCommandExplination} />
    )}
  </li>
  <br />
  <li>
    ...
    {props.beforeBuildCommandExplination && (
      <span dangerouslySetInnerHTML={props.beforeBuildCommandExplination} />
    )}
  </li>
</ol>
