...
<TauriInit
  destDirExplination={{
    __html:
      "For our example React project this will be <code>../build</code>. Note that it may be something different like <code>../dist</code> if you're using a different framework.",
  }}
  devPathExplination={{
    __html:
      "For our example React project this will be <code>http://localhost:3000</code>. Note that it may be something different (or even a directory) if you're using a different framework.",
  }}
