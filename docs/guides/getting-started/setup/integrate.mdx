...
<TauriInit
  ...
  devPathExplination={{
    __html:
      "For our example React project this will be <code>http://localhost:3000</code>. Note that it may be something different (or even a directory) if you're a different framework.",
  }}
