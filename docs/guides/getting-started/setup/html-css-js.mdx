...
<Image img={'/img/guides/html-css-js-light.png#gh-light-mode-only'} />
<Image img={'/img/guides/html-css-js-dark.png#gh-dark-mode-only'} />
...
<Image img={'/img/guides/html-css-js-dev-light.png#gh-light-mode-only'} />
<Image img={'/img/guides/html-css-js-dev-dark.png#gh-dark-mode-only'} />
