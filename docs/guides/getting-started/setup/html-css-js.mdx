...
import desktopLightPreview from './assets/html-css-js/html-css-js-light.png'
import desktopDarkPreview from './assets/html-css-js/html-css-js-dark.png'
import androidLightPreview from './assets/html-css-js/android-html-css-js-light.png'
import iosLightPreview from './assets/html-css-js/ios-html-css-js-light.png'
import desktopLightProgress from './assets/html-css-js/html-css-js-dev-light.png'
import desktopDarkProgress from './assets/html-css-js/html-css-js-dev-dark.png'
...
<Tabs groupId="developmentProgress">
  <TabItem value="desktop" label="Desktop" default>
    <ThemedImage
