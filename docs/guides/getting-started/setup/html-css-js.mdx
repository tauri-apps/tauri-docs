...
<Image
  className="gh-light-mode-only"
  img={require('./html-css-js-light.png')}
/>
<Image className="gh-dark-mode-only" img={require('./html-css-js-dark.png')} />
...
<Image
  className="gh-light-mode-only"
  img={require('./html-css-js-dev-light.png')}
/>
<Image
  className="gh-dark-mode-only"
  img={require('./html-css-js-dev-dark.png')}
/>
