...
import desktopLightPreview from '/img/guides/getting-started/setup/html-css-js/html-css-js-light.png'
import desktopDarkPreview from '/img/guides/getting-started/setup/html-css-js/html-css-js-dark.png'
import androidLightPreview from '/img/guides/getting-started/setup/html-css-js/android-html-css-js-light.png'
import iosLightPreview from '/img/guides/getting-started/setup/html-css-js/ios-html-css-js-light.png'
import desktopLightProgress from '/img/guides/getting-started/setup/html-css-js/html-css-js-dev-light.png'
import desktopDarkProgress from '/img/guides/getting-started/setup/html-css-js/html-css-js-dev-dark.png'
...
<Tabs groupId="platform">
  <TabItem value="desktop" label="Desktop" default>
    <ThemedImage
      ...
      sources={{
        light: desktopLightProgress,
        dark: desktopDarkProgress,
      }}
    />
  </TabItem>
  <TabItem value="android" label="Android">
