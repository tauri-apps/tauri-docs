---
description: Build a Tauri app from scratch using HTML, CSS, JavaScript, and Node.js
...
Because we don't use a frontend bundler with Hot Module Reloading (HMR) for this tutorial we will use `../ui` as the values for steps 3 and 4 below.
