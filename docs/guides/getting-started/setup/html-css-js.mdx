...
<TauriInit
  destDirExplination="Use ../ui for this value."
  devPathExplination="Use ../ui for this value."
  beforeDevCommandExplination="You can leave this blank since nothing needs to be compiled."
  beforeBuildCommandExplination="You can leave this blank since nothing needs to be compiled."
/>
