...
import desktopLightPreview from './assets/sveltekit/sveltekit-light.png'
import desktopDarkPreview from './assets/sveltekit/sveltekit-dark.png'
import androidLightPreview from './assets/sveltekit/android-sveltekit-light.png'
import iosLightPreview from './assets/sveltekit/ios-sveltekit-light.png'
import desktopLightApplicationWindow from './assets/sveltekit/sveltekit-dev-light.png'
import desktopDarkApplicationWindow from './assets/sveltekit/sveltekit-dev-dark.png'
...
For mobile support, you also need to install the `internal-ip` NPM dependency and change the `vite.config.js` file:
...
<TauriInit
  ...
  beforeDevCommandExplination={{
    __html:
      'Use <code>PUBLIC_TAURI_DEV=true npm run dev</code> (be sure to adapt to use your package manager of choice).',
  }}
...
<Tabs groupId="applicationWindow">
  <TabItem value="desktop" label="Desktop" default>
    <ThemedImage
