...
import desktopLightPreview from '/img/guides/getting-started/setup/sveltekit/sveltekit-light.png'
import desktopDarkPreview from '/img/guides/getting-started/setup/sveltekit/sveltekit-dark.png'
import androidLightPreview from '/img/guides/getting-started/setup/sveltekit/android-sveltekit-light.png'
import iosLightPreview from '/img/guides/getting-started/setup/sveltekit/ios-sveltekit-light.png'
import desktopLightApplicationWindow from '/img/guides/getting-started/setup/sveltekit/sveltekit-dev-light.png'
import desktopDarkApplicationWindow from '/img/guides/getting-started/setup/sveltekit/sveltekit-dev-dark.png'
...
<TauriInit
  ...
  beforeDevCommandExplination={{
    __html:
      'Use <code>PUBLIC_TAURI_DEV=true npm run dev</code> (make sure to adapt this to use the package manager of your choice).',
  }}
