...
**Defined in:** [cli.ts:27](https://github.com/tauri-apps/tauri/blob/fd3b5a1/tooling/api/src/cli.ts#L27)
...
**Defined in:** [cli.ts:23](https://github.com/tauri-apps/tauri/blob/fd3b5a1/tooling/api/src/cli.ts#L23)
...
**Defined in:** [cli.ts:42](https://github.com/tauri-apps/tauri/blob/fd3b5a1/tooling/api/src/cli.ts#L42)

##### `subcommand`

>  **subcommand**: `null` \| [`SubcommandMatch`](cli.md#subcommandmatch)

**Defined in:** [cli.ts:43](https://github.com/tauri-apps/tauri/blob/fd3b5a1/tooling/api/src/cli.ts#L43)
...
**Defined in:** [cli.ts:35](https://github.com/tauri-apps/tauri/blob/fd3b5a1/tooling/api/src/cli.ts#L35)

##### `name`

>  **name**: `string`

**Defined in:** [cli.ts:34](https://github.com/tauri-apps/tauri/blob/fd3b5a1/tooling/api/src/cli.ts#L34)
