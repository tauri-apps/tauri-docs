...
**Defined in:** [os.ts:43](https://github.com/tauri-apps/tauri/blob/8a1b128/tooling/api/src/os.ts#L43)

### `OsType`

>  **OsType**: `"Linux"` \| `"Darwin"` \| `"Windows_NT"`

**Defined in:** [os.ts:41](https://github.com/tauri-apps/tauri/blob/8a1b128/tooling/api/src/os.ts#L41)

### `Platform`

>  **Platform**: `"linux"` \| `"darwin"` \| `"ios"` \| `"freebsd"` \| `"dragonfly"` \| `"netbsd"` \| `"openbsd"` \| `"solaris"` \| `"android"` \| `"win32"`

**Defined in:** [os.ts:29](https://github.com/tauri-apps/tauri/blob/8a1b128/tooling/api/src/os.ts#L29)
...
**Defined in:** [os.ts:63](https://github.com/tauri-apps/tauri/blob/8a1b128/tooling/api/src/os.ts#L63)
