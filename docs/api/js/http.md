...
| :------ | :------ | :------ |
| <div class="anchor-with-padding" id="http.ResponseType.Binary"><a href="#http.ResponseType.Binary">`Binary`</a></div> | `3` | [http.ts:74](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L74) |
| <div class="anchor-with-padding" id="http.ResponseType.JSON"><a href="#http.ResponseType.JSON">`JSON`</a></div> | `1` | [http.ts:72](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L72) |
| <div class="anchor-with-padding" id="http.ResponseType.Text"><a href="#http.ResponseType.Text">`Text`</a></div> | `2` | [http.ts:73](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L73) |
...
**Defined in:** [http.ts:95](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L95)

##### `type`

>  **type**: `string`

**Defined in:** [http.ts:94](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L94)
...
**Defined in:** [http.ts:303](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L303)
...
**Defined in:** [http.ts:286](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L286)
...
**Defined in:** [http.ts:282](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L282)
...
**Defined in:** [http.ts:280](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L280)
...
**Defined in:** [http.ts:284](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L284)
...
**Defined in:** [http.ts:278](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L278)
...
**Defined in:** [http.ts:276](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L276)
...
**Defined in:** [http.ts:65](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L65)
...
**Defined in:** [http.ts:64](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L64)
...
**Defined in:** [http.ts:53](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L53)

##### `secs`

>  **secs**: `number`

**Defined in:** [http.ts:52](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L52)
...
**Defined in:** [http.ts:81](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L81)

##### `fileName`

> `Optional` **fileName**: `string`

**Defined in:** [http.ts:83](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L83)

##### `mime`

> `Optional` **mime**: `string`

**Defined in:** [http.ts:82](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L82)
...
**Defined in:** [http.ts:250](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L250)

##### `headers`

> `Optional` **headers**: [`Record`]( https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type )<`string`, `any`\>

**Defined in:** [http.ts:248](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L248)

##### `method`

>  **method**: [`HttpVerb`](http.md#httpverb)

**Defined in:** [http.ts:246](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L246)

##### `query`

> `Optional` **query**: [`Record`]( https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type )<`string`, `any`\>

**Defined in:** [http.ts:249](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L249)

##### `responseType`

> `Optional` **responseType**: [`ResponseType`](http.md#responsetype)

**Defined in:** [http.ts:252](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L252)

##### `timeout`

> `Optional` **timeout**: `number` \| [`Duration`](http.md#duration)

**Defined in:** [http.ts:251](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L251)

##### `url`

>  **url**: `string`

**Defined in:** [http.ts:247](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L247)
...
**Defined in:** [http.ts:258](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L258)
...
**Defined in:** [http.ts:229](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L229)
...
**Defined in:** [http.ts:86](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L86)
...
**Defined in:** [http.ts:256](https://github.com/tauri-apps/tauri/blob/06fdcc0/tooling/api/src/http.ts#L256)
