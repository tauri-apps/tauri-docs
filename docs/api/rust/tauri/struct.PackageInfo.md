...
### impl [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")

#### pub fn [package_name](/docs/api/rust/tauri/about:blank#method.package_name)(&self) -> [String](https://doc.rust-lang.org/1.54.0/alloc/string/struct.String.html "struct alloc::string::String")
...
### impl [Clone](https://doc.rust-lang.org/1.54.0/core/clone/trait.Clone.html "trait core::clone::Clone") for [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")

#### pub fn [clone](https://doc.rust-lang.org/1.54.0/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")
...
### impl [Debug](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")
...
### impl [RefUnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.RefUnwindSafe.html "trait std::panic::RefUnwindSafe") for [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")

### impl [Send](https://doc.rust-lang.org/1.54.0/core/marker/trait.Send.html "trait core::marker::Send") for [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")

### impl [Sync](https://doc.rust-lang.org/1.54.0/core/marker/trait.Sync.html "trait core::marker::Sync") for [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")

### impl [Unpin](https://doc.rust-lang.org/1.54.0/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")

### impl [UnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.UnwindSafe.html "trait std::panic::UnwindSafe") for [PackageInfo](/docs/api/rust/tauri/struct.PackageInfo "struct tauri::PackageInfo")
