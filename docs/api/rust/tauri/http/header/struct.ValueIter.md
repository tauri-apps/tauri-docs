---
title: Struct tauri::http::header::ValueIter
sidebar_label: struct.ValueIter
custom_edit_url: null
---

  # Struct tauri::http&#x3A;:header::ValueIter,

```rs
pub struct ValueIter<'a, T> { /* fields omitted */ }
```
...
### impl&lt;'a, T> [Debug](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T> where T: [Debug](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html "trait core::fmt::Debug"),[\[src\]](https://docs.rs/http/0.2.4/src/http/header/map.rs.html#188 "goto source code")
...
### impl&lt;'a, T> [DoubleEndedIterator](https://doc.rust-lang.org/1.54.0/core/iter/traits/double_ended/trait.DoubleEndedIterator.html "trait core::iter::traits::double_ended::DoubleEndedIterator") for [ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T> where T: 'a,[\[src\]](https://docs.rs/http/0.2.4/src/http/header/map.rs.html#2569-2597 "goto source code")

#### pub fn [next_back](https://doc.rust-lang.org/1.54.0/core/iter/traits/double_ended/trait.DoubleEndedIterator.html#tymethod.next_back)(&mut self) -> [Option](https://doc.rust-lang.org/1.54.0/core/option/enum.Option.html "enum core::option::Option")&lt;&lt;[ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T> as [Iterator](https://doc.rust-lang.org/1.54.0/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")>::[Item](https://doc.rust-lang.org/1.54.0/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")>[\[src\]](https://docs.rs/http/0.2.4/src/http/header/map.rs.html#2570 "goto source code")
...
#### pub fn [next](https://doc.rust-lang.org/1.54.0/core/iter/traits/iterator/trait.Iterator.html#tymethod.next)(&mut self) -> [Option](https://doc.rust-lang.org/1.54.0/core/option/enum.Option.html "enum core::option::Option")&lt;&lt;[ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T> as [Iterator](https://doc.rust-lang.org/1.54.0/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")>::[Item](https://doc.rust-lang.org/1.54.0/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "type core::iter::traits::iterator::Iterator::Item")>[\[src\]](https://docs.rs/http/0.2.4/src/http/header/map.rs.html#2516 "goto source code")
...
### impl&lt;'a, T> [FusedIterator](https://doc.rust-lang.org/1.54.0/core/iter/traits/marker/trait.FusedIterator.html "trait core::iter::traits::marker::FusedIterator") for [ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T>

[\[src\]](https://docs.rs/http/0.2.4/src/http/header/map.rs.html#2599 "goto source code")

## Auto Trait Implementations

### impl&lt;'a, T> [RefUnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.RefUnwindSafe.html "trait std::panic::RefUnwindSafe") for [ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T> where T: [RefUnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.RefUnwindSafe.html "trait std::panic::RefUnwindSafe"),

### impl&lt;'a, T> [Send](https://doc.rust-lang.org/1.54.0/core/marker/trait.Send.html "trait core::marker::Send") for [ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T> where T: [Sync](https://doc.rust-lang.org/1.54.0/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl&lt;'a, T> [Sync](https://doc.rust-lang.org/1.54.0/core/marker/trait.Sync.html "trait core::marker::Sync") for [ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T> where T: [Sync](https://doc.rust-lang.org/1.54.0/core/marker/trait.Sync.html "trait core::marker::Sync"),

### impl&lt;'a, T> [Unpin](https://doc.rust-lang.org/1.54.0/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T>

### impl&lt;'a, T> [UnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.UnwindSafe.html "trait std::panic::UnwindSafe") for [ValueIter](/docs/api/rust/tauri/struct.ValueIter "struct tauri::http&#x3A;:header::ValueIter")&lt;'a, T> where T: [RefUnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.RefUnwindSafe.html "trait std::panic::RefUnwindSafe"),
