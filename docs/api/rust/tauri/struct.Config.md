...
### impl&lt;'de> [Deserialize](https://docs.rs/serde/1.0.129/serde/de/trait.Deserialize.html "trait serde::de::Deserialize")&lt;'de> for [Config](/docs/api/rust/tauri/struct.Config "struct tauri::Config")
