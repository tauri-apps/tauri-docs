...
| Name | Type | Default | Description |
| ---- | ---- | ------- | ----------- |
| <div className="anchor-with-padding" id="windoweffectsconfig.effects">`effects`<a class="hash-link" href="#windoweffectsconfig.effects"></a></div> | [`WindowEffect[]`](#windoweffect)(required) | _null_ | List of Window effects to apply to the Window. Conflicting effects will apply the first one and ignore the rest. |
