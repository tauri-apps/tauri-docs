...
| <div className="anchor-with-padding" id="windowconfig.shadow">`shadow`<a class="hash-link" href="#windowconfig.shadow"></a></div> | `boolean` | `false` | Whether or not the window has shadow.<br /><br />## Platform-specific<br /><br />- **Windows:**<br />- `false` has no effect on decorated window, shadow are always ON.<br />- `true` will make ndecorated window have a 1px white border, and on Windows 11, it will have a rounded corners.<br />- **Linux:** Unsupported. |
...
| <div className="anchor-with-padding" id="windowallowlistconfig.setshadow">`setShadow`<a class="hash-link" href="#windowallowlistconfig.setshadow"></a></div> | `boolean` | `false` | Allows setting the shadow flag of the window. |
