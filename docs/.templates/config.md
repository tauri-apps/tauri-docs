...
The `tauri.conf.json` is a file generated by the [`tauri init`] command that lives in your Tauri application source directory (src-tauri).
...
[`tauri init`]: /docs/api/cli#tauri-init