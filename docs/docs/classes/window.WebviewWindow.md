...
[window.ts:1097](https://github.com/tauri-apps/tauri/blob/25bcf2b/tooling/api/src/window.ts#L1097)
...
[window.ts:1127](https://github.com/tauri-apps/tauri/blob/25bcf2b/tooling/api/src/window.ts#L1127)
