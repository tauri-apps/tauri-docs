...
[window.ts:1137](https://github.com/tauri-apps/tauri/blob/25bcf2b/tooling/api/src/window.ts#L1137)
...
[window.ts:1231](https://github.com/tauri-apps/tauri/blob/25bcf2b/tooling/api/src/window.ts#L1231)
...
[window.ts:1198](https://github.com/tauri-apps/tauri/blob/25bcf2b/tooling/api/src/window.ts#L1198)
...
[window.ts:207](https://github.com/tauri-apps/tauri/blob/25bcf2b/tooling/api/src/window.ts#L207)
...
[window.ts:195](https://github.com/tauri-apps/tauri/blob/25bcf2b/tooling/api/src/window.ts#L195)
...
[window.ts:1216](https://github.com/tauri-apps/tauri/blob/25bcf2b/tooling/api/src/window.ts#L1216)
