...
---
  ...
  # Struct tauri::GlobalWindowEvent,

```rs
pub struct GlobalWindowEvent<R: Runtime = Wry> { /* fields omitted */ }
```
...
### impl&lt;R = [Wry](/docs/api/rust/tauri/struct.Wry "struct tauri::Wry")> \&#33;[UnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.UnwindSafe.html "trait std::panic::UnwindSafe") for [GlobalWindowEvent](/docs/api/rust/tauri/struct.GlobalWindowEvent "struct tauri::GlobalWindowEvent")&lt;R>
