...
#### `pub fn clone(&self) -> UserAttentionType`
...
#### `pub fn deserialize<__D>( __deserializer: __D ) -> Result<UserAttentionType, <__D as Deserializer<'de>>::Error> where __D: Deserializer<'de>,`

Deserialize this value from the given Serde deserializer. [Read more](https://docs.rs/serde/1.0.126/serde/de/trait.Deserialize.html#tymethod.deserialize)

### `impl PartialEq<UserAttentionType> for UserAttentionType`

#### `pub fn eq(&self, other: &UserAttentionType) -> bool`
