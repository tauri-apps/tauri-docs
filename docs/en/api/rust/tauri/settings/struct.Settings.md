...
---
  ...
  # Struct tauri::settings::Settings,
...
### impl [Clone](https://doc.rust-lang.org/1.54.0/core/clone/trait.Clone.html "trait core::clone::Clone") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")

#### fn [clone](https://doc.rust-lang.org/1.54.0/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")
...
### impl [Debug](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")

#### fn [fmt](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/1.54.0/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")&lt;'\_>) -> [Result](https://doc.rust-lang.org/1.54.0/core/fmt/type.Result.html "type core::fmt::Result")[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html#tymethod.fmt)

### impl [Default](https://doc.rust-lang.org/1.54.0/core/default/trait.Default.html "trait core::default::Default") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")

#### fn [default](https://doc.rust-lang.org/1.54.0/core/default/trait.Default.html#tymethod.default)() -> [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")
...
### impl&lt;'de> [Deserialize](https://docs.rs/serde/1.0.127/serde/de/trait.Deserialize.html "trait serde::de::Deserialize")&lt;'de> for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")

#### fn [deserialize](https://docs.rs/serde/1.0.127/serde/de/trait.Deserialize.html#tymethod.deserialize)&lt;\_\_D>(\_\_deserializer: \_\_D) -> [Result](https://doc.rust-lang.org/1.54.0/core/result/enum.Result.html "enum core::result::Result")&lt;Self, \_\_D::[Error](https://docs.rs/serde/1.0.127/serde/de/trait.Deserializer.html#associatedtype.Error "type serde::de::Deserializer::Error")> where \_\_D: [Deserializer](https://docs.rs/serde/1.0.127/serde/de/trait.Deserializer.html "trait serde::de::Deserializer")&lt;'de>,[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")
...
### impl [Serialize](https://docs.rs/serde/1.0.127/serde/ser/trait.Serialize.html "trait serde::ser::Serialize") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")

#### fn [serialize](https://docs.rs/serde/1.0.127/serde/ser/trait.Serialize.html#tymethod.serialize)&lt;\_\_S>(&self, \_\_serializer: \_\_S) -> [Result](https://doc.rust-lang.org/1.54.0/core/result/enum.Result.html "enum core::result::Result")&lt;\_\_S::[Ok](https://docs.rs/serde/1.0.127/serde/ser/trait.Serializer.html#associatedtype.Ok "type serde::ser::Serializer::Ok"), \_\_S::[Error](https://docs.rs/serde/1.0.127/serde/ser/trait.Serializer.html#associatedtype.Error "type serde::ser::Serializer::Error")> where \_\_S: [Serializer](https://docs.rs/serde/1.0.127/serde/ser/trait.Serializer.html "trait serde::ser::Serializer"),[\[src\]](/docs/api/rust/tauri/../../src/tauri/settings.rs#24 "goto source code")
...
### impl [RefUnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.RefUnwindSafe.html "trait std::panic::RefUnwindSafe") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")

### impl [Send](https://doc.rust-lang.org/1.54.0/core/marker/trait.Send.html "trait core::marker::Send") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")

### impl [Sync](https://doc.rust-lang.org/1.54.0/core/marker/trait.Sync.html "trait core::marker::Sync") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")

### impl [Unpin](https://doc.rust-lang.org/1.54.0/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")

### impl [UnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.UnwindSafe.html "trait std::panic::UnwindSafe") for [Settings](/docs/api/rust/tauri/struct.Settings "struct tauri::settings::Settings")
