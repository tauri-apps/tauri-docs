...
A base directory to be used in [`resolve_path`](/docs/api/rust/tauri/fn.resolve_path "resolve_path").
...
The default App config directory. Resolves to [`BaseDirectory::Config`](/docs/api/rust/tauri/enum.BaseDirectory#variant.Config "BaseDirectory::Config").
...
### impl [Clone](https://doc.rust-lang.org/1.54.0/core/clone/trait.Clone.html "trait core::clone::Clone") for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/path.rs#22 "goto source code")

#### fn [clone](https://doc.rust-lang.org/1.54.0/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/path.rs#22 "goto source code")
...
### impl [Debug](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/path.rs#22 "goto source code")

#### fn [fmt](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html#tymethod.fmt)(&self, f: &mut [Formatter](https://doc.rust-lang.org/1.54.0/core/fmt/struct.Formatter.html "struct core::fmt::Formatter")&lt;'\_>) -> [Result](https://doc.rust-lang.org/1.54.0/core/fmt/type.Result.html "type core::fmt::Result")[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/path.rs#22 "goto source code")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html#tymethod.fmt)

### impl&lt;'de> [Deserialize](https://docs.rs/serde/1.0.129/serde/de/trait.Deserialize.html "trait serde::de::Deserialize")&lt;'de> for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/path.rs#22 "goto source code")

#### fn [deserialize](https://docs.rs/serde/1.0.129/serde/de/trait.Deserialize.html#tymethod.deserialize)&lt;D>(deserializer: D) -> [Result](https://doc.rust-lang.org/1.54.0/core/result/enum.Result.html "enum core::result::Result")&lt;Self, D::[Error](https://docs.rs/serde/1.0.129/serde/de/trait.Deserializer.html#associatedtype.Error "type serde::de::Deserializer::Error")> where D: [Deserializer](https://docs.rs/serde/1.0.129/serde/de/trait.Deserializer.html "trait serde::de::Deserializer")&lt;'de>,[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/path.rs#22 "goto source code")
...
### impl [Serialize](https://docs.rs/serde/1.0.129/serde/ser/trait.Serialize.html "trait serde::ser::Serialize") for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/path.rs#22 "goto source code")

#### fn [serialize](https://docs.rs/serde/1.0.129/serde/ser/trait.Serialize.html#tymethod.serialize)&lt;S>(&self, serializer: S) -> [Result](https://doc.rust-lang.org/1.54.0/core/result/enum.Result.html "enum core::result::Result")&lt;S::[Ok](https://docs.rs/serde/1.0.129/serde/ser/trait.Serializer.html#associatedtype.Ok "type serde::ser::Serializer::Ok"), S::[Error](https://docs.rs/serde/1.0.129/serde/ser/trait.Serializer.html#associatedtype.Error "type serde::ser::Serializer::Error")> where S: [Serializer](https://docs.rs/serde/1.0.129/serde/ser/trait.Serializer.html "trait serde::ser::Serializer"),[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/path.rs#22 "goto source code")
...
### impl [RefUnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.RefUnwindSafe.html "trait std::panic::RefUnwindSafe") for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")

### impl [Send](https://doc.rust-lang.org/1.54.0/core/marker/trait.Send.html "trait core::marker::Send") for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")

### impl [Sync](https://doc.rust-lang.org/1.54.0/core/marker/trait.Sync.html "trait core::marker::Sync") for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")

### impl [Unpin](https://doc.rust-lang.org/1.54.0/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")

### impl [UnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.UnwindSafe.html "trait std::panic::UnwindSafe") for [BaseDirectory](/docs/api/rust/tauri/enum.BaseDirectory "enum tauri::api::path::BaseDirectory")
