...
# Enum [tauri](/docs/api/rust/tauri/../../index.html)::​[api](/docs/api/rust/tauri/../index.html)::​[config](/docs/api/rust/tauri/index.html)::​[AppUrl](/docs/api/rust/tauri/)

```rs
#[non_exhaustive]pub enum AppUrl {
    Url(WindowUrl),
