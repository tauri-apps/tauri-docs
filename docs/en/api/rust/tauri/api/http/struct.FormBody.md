...
_Defined in: [http.rs:216-221](https://github.com/tauri-apps/tauri/blob/af634db/core/tauri/src/http.rs#L216-221)_
...
_Defined in: [http.rs:218-220](https://github.com/tauri-apps/tauri/blob/af634db/core/tauri/src/http.rs#L218-220)_
...
```rs
impl<'de> Deserialize<'de> for FormBody
```

_Defined in: [http.rs:213](https://github.com/tauri-apps/tauri/blob/af634db/core/tauri/src/http.rs#L213)_
