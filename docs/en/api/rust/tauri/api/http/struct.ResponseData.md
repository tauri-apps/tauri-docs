...
### `impl Serialize for ResponseData`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/http.rs#386 "goto source code")

#### `fn serialize<__S>(&self, __serializer: __S) -> Result<__S::Ok, __S::Error> where __S: Serializer,`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/http.rs#386 "goto source code")
