...
### `impl Client`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/http.rs#75-127 "goto source code")

#### `pub async fn send(&self, request: HttpRequestBuilder) -> Result<Response>`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/http.rs#80-126 "goto source code")
...
### `impl Clone for Client`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/http.rs#71 "goto source code")

#### `fn clone(&self) -> Client`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/http.rs#71 "goto source code")
