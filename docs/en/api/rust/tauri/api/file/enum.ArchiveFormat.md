...
### `impl Clone for ArchiveFormat`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")

#### `fn clone(&self) -> ArchiveFormat`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")
...
### `impl Copy for ArchiveFormat`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")

### `impl Debug for ArchiveFormat`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")

#### `fn fmt(&self, f: &mut Formatter<'_>) -> Result`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")

Formats the value using the given formatter. [Read more](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html#tymethod.fmt)

### `impl PartialEq<ArchiveFormat> for ArchiveFormat`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")

#### `fn eq(&self, other: &ArchiveFormat) -> bool`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")

This method tests for `self` and `other` values to be equal, and is used by `==`. [Read more](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)

#### `fn ne(&self, other: &ArchiveFormat) -> bool`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")

This method tests for `!=`.

### `impl StructuralPartialEq for ArchiveFormat`[\[src\]](/docs/api/rust/tauri/../../../src/tauri/api/file/extract.rs#10 "goto source code")
