...
### impl&lt;I> UnicodeNormalization&lt;I> for I where I: [Iterator](https://doc.rust-lang.org/1.54.0/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator")&lt;Item = [char](https://doc.rust-lang.org/1.54.0/std/primitive.char.html)>,

#### pub fn [nfd](/docs/api/rust/tauri/about:blank#tymethod.nfd)(self) -> Decompositions&lt;I>

Returns an iterator over the string in Unicode Normalization Form D (canonical decomposition). [Read more](/docs/api/rust/tauri/about:blank#tymethod.nfd)

#### pub fn [nfkd](/docs/api/rust/tauri/about:blank#tymethod.nfkd)(self) -> Decompositions&lt;I>

Returns an iterator over the string in Unicode Normalization Form KD (compatibility decomposition). [Read more](/docs/api/rust/tauri/about:blank#tymethod.nfkd)

#### pub fn [nfc](/docs/api/rust/tauri/about:blank#tymethod.nfc)(self) -> Recompositions&lt;I>

An Iterator over the string in Unicode Normalization Form C (canonical decomposition followed by canonical composition). [Read more](/docs/api/rust/tauri/about:blank#tymethod.nfc)

#### pub fn [nfkc](/docs/api/rust/tauri/about:blank#tymethod.nfkc)(self) -> Recompositions&lt;I>

An Iterator over the string in Unicode Normalization Form KC (compatibility decomposition followed by canonical composition). [Read more](/docs/api/rust/tauri/about:blank#tymethod.nfkc)

#### pub fn [cjk_compat_variants](/docs/api/rust/tauri/about:blank#tymethod.cjk_compat_variants)(self) -> Replacements&lt;I>

A transformation which replaces CJK Compatibility Ideograph codepoints with normal forms using Standardized Variation Sequences. This is not part of the canonical or compatibility decomposition algorithms, but performing it before those algorithms produces normalized output which better preserves the intent of the original text. [Read more](/docs/api/rust/tauri/about:blank#tymethod.cjk_compat_variants)

#### pub fn [stream_safe](/docs/api/rust/tauri/about:blank#tymethod.stream_safe)(self) -> StreamSafe&lt;I>

An Iterator over the string with Conjoining Grapheme Joiner characters inserted according to the Stream-Safe Text Process (UAX15-D4) [Read more](/docs/api/rust/tauri/about:blank#tymethod.stream_safe)
