...
### impl&lt;'de> [Deserialize](https://docs.rs/serde/1.0.127/serde/de/trait.Deserialize.html "trait serde::de::Deserialize")&lt;'de> for [Position](/docs/api/rust/tauri/enum.Position "enum tauri::Position")
...
### impl [Serialize](https://docs.rs/serde/1.0.127/serde/ser/trait.Serialize.html "trait serde::ser::Serialize") for [Position](/docs/api/rust/tauri/enum.Position "enum tauri::Position")
