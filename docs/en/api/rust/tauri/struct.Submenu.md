---
title: Struct tauri::Submenu
sidebar_label: struct.Submenu
custom_edit_url: null
---

  # Struct tauri::Submenu,
...
`title: String``enabled: bool``inner: Menu`

## Implementations

### impl [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")

#### pub fn [new](/docs/api/rust/tauri/about:blank#method.new)&lt;S>(title: S, menu: [Menu](/docs/api/rust/tauri/struct.Menu "struct tauri::Menu")) -> [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu") where S: [Into](https://doc.rust-lang.org/1.54.0/core/convert/trait.Into.html "trait core::convert::Into")&lt;[String](https://doc.rust-lang.org/1.54.0/alloc/string/struct.String.html "struct alloc::string::String")>,

Creates a new submenu with the given title and menu items.

## Trait Implementations

### impl [Clone](https://doc.rust-lang.org/1.54.0/core/clone/trait.Clone.html "trait core::clone::Clone") for [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")

#### pub fn [clone](https://doc.rust-lang.org/1.54.0/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")
...
### impl [Debug](https://doc.rust-lang.org/1.54.0/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")
...
### impl [RefUnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.RefUnwindSafe.html "trait std::panic::RefUnwindSafe") for [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")

### impl [Send](https://doc.rust-lang.org/1.54.0/core/marker/trait.Send.html "trait core::marker::Send") for [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")

### impl [Sync](https://doc.rust-lang.org/1.54.0/core/marker/trait.Sync.html "trait core::marker::Sync") for [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")

### impl [Unpin](https://doc.rust-lang.org/1.54.0/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")

### impl [UnwindSafe](https://doc.rust-lang.org/1.54.0/std/panic/trait.UnwindSafe.html "trait std::panic::UnwindSafe") for [Submenu](/docs/api/rust/tauri/struct.Submenu "struct tauri::Submenu")
