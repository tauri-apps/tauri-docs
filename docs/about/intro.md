...
If you want to know more about the technical details, then please visit the [Introduction](/docs/guides/getting-started/beginning-tutorial). If you want to know more about this project's philosophy - then keep reading.
