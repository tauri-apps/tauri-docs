...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:dn,depthTest:!1,depthWrite:!1})}function _o(){return new en({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ia(),fragmentShader:`
		...
		`,blending:dn,depthTest:!1,depthWrite:!1})}function xo(){return new en({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ia(),fragmentShader:`
