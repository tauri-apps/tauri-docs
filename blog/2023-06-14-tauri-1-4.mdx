...
The *internal*[^internal-audit] audit was performed by Tillmann [@tillmann-crabnebula](https://github.com/tillmann-crabnebula)
...
[^internal-audit]: It is internal in the sense that we are also involved in the project itself but performed with the help of an external entity. Calling it external security audit would create false impressions.