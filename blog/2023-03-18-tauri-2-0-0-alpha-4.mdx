...
# 2.0.0-alpha.4 is out

![Tauri 1.2 Launch Hero Image](./tauri_2_0_0_alpha_0/header.png)

A new alpha release for the 2.0 has been published! This release includes all changes from the upcoming 1.3 release, an important breaking change on the HTTP client and native mobile capabilities for Tauri plugins! 
...
```swift,filename=ExamplePlugin.swift
import UIKit
import WebKit
import Tauri
