...
The Tauri team is happy to announce the 1.2.0 release. It includes a security fix, so we encourage new and existing users to update to one of the fixed version. Other changes were internally audited and no security issues were found.
...
The patch is also available in 1.0.7 and 1.1.1. See [the advisory](https://github.com/tauri-apps/tauri/security/advisories/GHSA-q9wv-22m9-vhqh) for more details.
