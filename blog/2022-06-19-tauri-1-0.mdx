...
See our [Quick Start guides](/next/guides/getting-started/setup/) to start building with Tauri. <!-- TODO: revert to v1 on release -->
...
The apps you make are [lean and performant](/next/references/benchmarks), which reduces electricity, storage space, and general natural resource consumption. Every byte saved is a leaf on a tree that gets to grow.<!-- TODO: revert to stable version on release -->
